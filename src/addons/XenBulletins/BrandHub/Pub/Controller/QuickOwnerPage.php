...
class QuickOwnerPage extends AbstractController
{
	...
	{        
		...
		return $this->view('XenBulletins\BrandHub:QuickReview', 'bh_quick_owner_page', $viewParams);
	}
...
//        $items = $db->fetchPairs($sql);
	...
	{        
            ...
            $userItemPage = $this->finder('XenBulletins\BrandHub:OwnerPage')->where('item_id', $itemId)->where('user_id', $visitor->user_id)->fetchOne();
            ...
            return $this->view('XenBulletins\BrandHub:QuickReview', 'bh_quick_ownerPage_content', $viewParams);
	}
