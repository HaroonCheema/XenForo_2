...
/**
 * COLUMNS
 * @property int|null post_comment_id
 ...
 * @property \XenBulletins\BrandHub\Entity\OwnerPagePost OwnerPagePost
 ...
 */
class OwnerPagePostComment extends Entity implements RenderableContentInterface, LinkableInterface
{
	use ReactionTrait;
	...
	public function canView(&$error = null)
	{
		...
		{
			if (
				!$ownerPagePost->canViewModeratedComments()
		...
		return $ownerPagePost->canView($error);
	}
	...
	public function canViewAttachments(&$error = null): bool
	{
		...
		return $ownerPagePost->canViewAttachments($error);
	}
	...
	public function canDelete($type = 'soft', &$error = null)
	{
		...
		return (
			(
				$this->OwnerPagePost
				&& $visitor->user_id == $this->OwnerPagePost->OwnerPage->user_id
	...
	public function canSendModeratorActionAlert()
	{
		...
		return (
			$this->OwnerPagePost->canSendModeratorActionAlert()
	...
	public function isLastComment()
	{
		return (
			$this->OwnerPagePost
			&& $this->OwnerPagePost->last_comment_date == $this->comment_date
		);
	}
	...
	protected function _postSave()
	{
		...
		$this->updateOwnerPagePostRecord();

		if ($this->isUpdate() && $this->getOption('log_moderator'))
		{
			$this->app()->logger()->logModeratorChanges('bh_ownerPage_post_comment', $this);
		}
	}
	...
	protected function commentHidden($hardDelete = false)
	{
		...
		$alertRepo->fastDeleteAlertsForContent('bh_ownerPage_post_comment', $this->post_comment_id);
	}

	protected function updateOwnerPagePostRecord()
	{
		if (!$this->OwnerPagePost || !$this->OwnerPagePost->exists())
		{
			return;
		}
		...
		if ($visibilityChange == 'enter')
		{
			$this->OwnerPagePost->commentAdded($this);
			$this->OwnerPagePost->save();
		}
		else if ($visibilityChange == 'leave')
		{
			$this->OwnerPagePost->commentRemoved($this);
			$this->OwnerPagePost->save();
		}
	}
	...
	protected function submitHamData()
	{
		...
		$submitter->submitHam('bh_ownerPage_post_comment', $this->post_comment_id);
	}
	...
	protected function _postDelete()
	{
		...
		if ($this->OwnerPagePost && $this->message_state == 'visible')
		{
			$this->OwnerPagePost->commentRemoved($this);
			$this->OwnerPagePost->save();
		}
		...
		{
			$this->app()->logger()->logModeratorAction('bh_ownerPage_post_comment', $this, 'delete_hard');
		}

		/** @var \XF\Repository\Attachment $attachRepo */
		$attachRepo = $this->repository('XF:Attachment');
		$attachRepo->fastDeleteContentAttachments('bh_ownerPage_post_comment', $this->post_comment_id);
	}
...
//	}
	...
	{
		$route = $canonical ? 'canonical:owner-page-posts/comments' : 'owner-page-posts/comments';
		return $this->app()->router('public')->buildLink($route, $this, $extraParams, $hash);
	}

	public function getContentPublicRoute()
	{
		return 'owner-page-posts/comments';
	}

	public function getContentTitle(string $context = '')
	{
		return \XF::phrase('owner_page_post_comment_by_x', ['username' => $this->username]);
	}

	public static function getStructure(Structure $structure)
	{
		$structure->table = 'bh_owner_page_post_comment';
		$structure->shortName = 'XenBulletins\BrandHub:OwnerPagePostComment';
		$structure->contentType = 'bh_ownerPage_post_comment';
		$structure->primaryKey = 'post_comment_id';
		$structure->columns = [
			'post_comment_id' => ['type' => self::UINT, 'autoIncrement' => true, 'nullable' => true],
			'post_id' => ['type' => self::UINT, 'required' => true, 'api' => true],
...
//			]
		...
		$structure->relations = [
			...
			'OwnerPagePost' => [
				'entity' => 'XenBulletins\BrandHub:OwnerPagePost',
				'type' => self::TO_ONE,
				'conditions' => 'post_id',
				'primary' => true
			],
		...
		$structure->defaultWith = ['OwnerPagePost'];
