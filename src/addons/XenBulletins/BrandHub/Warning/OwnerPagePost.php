...
class OwnerPagePost extends AbstractHandler
{
	...
	{
		return \XF::phrase('owner_page_post_by_x', ['name' => $title]);
	}
	...
	{
		return \XF::app()->router('public')->buildLink(($canonical ? 'canonical:' : '') . 'owner-page-posts', $entity);
	}
	...
	public function takeContentAction(Entity $entity, $action, array $options)
	{
		...
		else if ($action == 'delete')
		{
			...
			$deleter = \XF::app()->service('XenBulletins\BrandHub:OwnerPagePost\Deleter', $entity);
