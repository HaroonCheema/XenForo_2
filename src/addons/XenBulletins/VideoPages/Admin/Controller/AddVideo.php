...
class AddVideo extends AbstractController
{
    ...
    public function actionSave(ParameterBag $params)
    {
        ...
        if ($video->intro_ph_id && $video->desc_ph_id) {
        ...
        if ($this->isPost()) {
            ...
            if ($uploads['video_logo'] && $uploads['video_sideimg'] && $uploads['video_img']) {
                $i = 0;
    ...
    public function videoSaveProcess(\XenBulletins\VideoPages\Entity\AddVideo $video)
    {
        ...
        if (preg_match(
            ...
            if (preg_match('/(?:youtu\.be\/|v=|\/embed\/|\/v\/|\/watch\?v=|&v=|\/shorts\/)([a-zA-Z0-9_-]{11})/', $videoUrl, $matches)) {
                $video_id = $matches[1];
            }
    ...
    public function actionDelete(ParameterBag $params)
    {
        ...
        return $plugin->actionDelete(
            $site,
            $this->buildLink('brand/delete', $site),
            $this->buildLink('brand/edit', $site),
            $this->buildLink('brand'),
            $site->video_link
        );
    }
}
