...
class EncokMesajKullanici extends AbstractWidget
{
	...
	public function render()
	{
		...
		if (!\XF::visitor()->canKullaniciIstatistikGor())
		{
			return '';
		}
		...
		{
            /*** gosterim limiti ***/
			if ($count == \XF::options()->xgtIstatistikGosterimLimiti)
			 {
		...
		return $this->renderer('xgt_FrmIstatistik_enCok_mesajKullanici', $viewParams);
	}
