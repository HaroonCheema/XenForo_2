...
class TouchLastView extends AbstractJob
{
    use ArgumentsParser;
    ...
    public static function create(int $roomId, int $userId, ?int $date)
    {
        ...
        \XF::app()->jobManager()->enqueueUnique(
            'rtc_touch_last_view:'.$roomId.':'.$userId,
            'BS\RealTimeChat:RoomMember\TouchLastView',
            [
                'room_id' => $roomId,
                'user_id' => $userId,
                'date' => $date
    ...
    {
        return 'Touching last view date for room member...';
    }
