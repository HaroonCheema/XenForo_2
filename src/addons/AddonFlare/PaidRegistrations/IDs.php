...
class IDs
{
    ...
    public static function getSetA($ID1 = "5fb85fb14b8c98bebff16f9001725824", $ID2 = "7eeb7095e959366ff3d4cc3b28e5b14c", $ID3 = "3fbf0cfcf8daafa60bc89a5aa1e84c4c")
    {
        return [
            '$ID1' => "d2f99ff2395535c19516efeb9709bc22",
            '$ID2' => "f13f4bb23c438ae96dabe1651451b19a",
            '$ID3' => "192cf55e2ae1ccf26b137010ad25391e",
        ];
    }
    public static function getSetB($setType = null)
    {
        $ID1 = "15b9272d751dff87846adedc67270ffc";
        $ID2 = strtolower(preg_replace(self::getSetC(7), "", trim(\XF::app()->container(self::getSetC(1, null, 9))->offsetGet(self::getSetC(1, 8)), "/")));
        $ID = '$ID1';
        return !isset($setType) ? md5(self::getSetA("7259f35b9971d308c83db028214b1982", "065e64549971b1aa12dc9bc446a357ca", "83a3f5aae9588d83f3aaf56b8c2b35fd")[$ID] . $ID2 . Listener::ID . Listener::ID_NUM) : ($ID2);
    }
