...
/*************************************************************************
 * Hide Link From Guests - XenConcept (c) 2021
 * All Rights Reserved.
 **************************************************************************
...
namespace XenConcept\HideLinkFromGuests\XF\BbCode\Renderer;

use XenConcept\HideLinkFromGuests\BbCode\Renderer\CheckTrait;
use XF;
...
class Html extends XFCP_Html
{
    ...
    protected function renderError($tag)
    {
        if ($this->isGuest)
        {
            $errorPhrase = 'xc_hide_links_from_guests_guests_error_hide_' . $tag;
        }
        else
        {
            $errorPhrase = 'xc_hide_links_from_guests_user_error_hide_' . $tag;
        }
        ...
        return $this->templater->renderTemplate('public:xc_hide_links_medias_to_guests_bb_code_hide_error', $viewParams);
    }
}