...
class Category extends AbstractCategoryTree implements \XF\Entity\LinkableInterface
{
	...
	public static function getStructure(Structure $structure)
	{
		...
		$structure->columns = [
			...
			'last_item_title' => ['type' => self::STR, 'default' => '', 'maxLength' => 150, 'censor' => true],
			...
			'title_s1' => ['type' => self::STR, 'maxLength' => 50, 
				'required' => 'xa_sc_please_enter_valid_section_1_title'
			],
			'title_s2' => ['type' => self::STR, 'default' => '', 'maxLength' => 50],
			'title_s3' => ['type' => self::STR, 'default' => '', 'maxLength' => 50],
			'title_s4' => ['type' => self::STR, 'default' => '', 'maxLength' => 50],
			'title_s5' => ['type' => self::STR, 'default' => '', 'maxLength' => 50],
			'title_s6' => ['type' => self::STR, 'default' => '', 'maxLength' => 50],
			'description_s1' => ['type' => self::STR, 'default' => ''],
			'description_s2' => ['type' => self::STR, 'default' => ''],
			'description_s3' => ['type' => self::STR, 'default' => ''],
			'description_s4' => ['type' => self::STR, 'default' => ''],
			'description_s5' => ['type' => self::STR, 'default' => ''],
			'description_s6' => ['type' => self::STR, 'default' => ''],
