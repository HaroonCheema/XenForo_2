...
class Item extends Entity implements \XF\BbCode\RenderableContentInterface, \XF\Entity\LinkableInterface
{
	...
	protected function _postSave()
	{
		...
		if ($this->isInsert())
		{
			$phone = $this->custom_fields['scfPhone'] ?? null;
			
	        $uniqueId = "spa_" . $this->item_id;
	        ...
	        \XF::app()->jobManager()->enqueueUnique($uniqueId, 'XenAddons\Showcase:SpaReviews', $jobData, false);
	        //\XF::app()->jobManager()->runUnique($uniqueId, 120);
		}
