...
class MyThreads extends AbstractController
{
	...
	public function actionIndex(ParameterBag $params)
	{
		...
		$forum = $this->assertViewableForum(12 ?: $params->node_name, $this->getForumViewExtraWith());
		...
		$this->assertCanonicalUrl($this->buildLink('my-threads', $forum, ['page' => $page]));
