...
namespace FS\SelectTeam\Service;
...
class Upload extends \XF\Service\AbstractService
{
    ...
    public function __construct(\XF\App $app, \FS\SelectTeam\Entity\Team $team)
    {
        parent::__construct($app);
        $this->setUser($team);
    }

    protected function setUser(\FS\SelectTeam\Entity\Team $team)
    {
    ...
    public function uploadImage()
    {
        ...
        foreach ($outputFiles as $code => $file) {
            $dataFile = $this->team->getAbstractedCustomImgPath();
