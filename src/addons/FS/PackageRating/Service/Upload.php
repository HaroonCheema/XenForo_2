...
namespace FS\PackageRating\Service;
...
class Upload extends \XF\Service\AbstractService
{
    ...
    public function __construct(\XF\App $app, \FS\PackageRating\Entity\PackageRating $rating)
    {
        parent::__construct($app);
        $this->setUser($rating);
    }

    protected function setUser(\FS\PackageRating\Entity\PackageRating $rating)
    {
    ...
    public function uploadImage()
    {
        ...
        foreach ($outputFiles as $code => $file) {
            $dataFile = $this->rating->getAbstractedCustomImgPath();
