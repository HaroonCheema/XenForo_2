...
namespace FS\GameReviews\Service;
...
class Upload extends \XF\Service\AbstractService
{
    ...
    public function __construct(\XF\App $app, \FS\GameReviews\Entity\GameReviews $rating)
    {
        parent::__construct($app);
        $this->setUser($rating);
    }

    protected function setUser(\FS\GameReviews\Entity\GameReviews $rating)
    {
