...
namespace FS\CreateZoomMeeting\Service;
...
class Meeting extends \XF\Service\AbstractService
{
    ...
    public function freshToken()
    {
        ...
        $refresh_token = \xf::options()->zoom_meeting_refresh_token;  // Set your refresh token here
        $client_id = \xf::options()->zoom_meeting_client_id;  // Set your client ID here
        $client_secret = \xf::options()->zoom_meeting_client_secret;  // Set your client secret here
        ...
        try {
            ...
            if (isset($tokenData['access_token'])) {
                ...
                $this->saveOption("zoom_meeting_access_token", $accessToken);
                $this->saveOption("zoom_meeting_refresh_token", $refresh_token);
            }
