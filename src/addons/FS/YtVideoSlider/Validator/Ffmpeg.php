...
namespace FS\YtVideoSlider\Validator;
...
class Ffmpeg extends \XF\Validator\AbstractValidator
{
	...
	public function getPrintableErrorValue($errorKey)
	{
		...
		{
			case 'path_error':
				return \XF::phrase('fs_yt_path_provided_was_not_valid');
				break;

			case 'path_find_error':
				return \XF::phrase('fs_yt_could_not_find_ffmpeg_at_path_specified');
				break;

			case 'version_error':
				return \XF::phrase('fs_yt_ffmpeg_version_requirement');
				break;

			case 'encoder_missing_png':
				return \XF::phrase('fs_yt_png_encoder_is_required_for_generating_thumbnails');
				break;

			case 'encoder_missing_libx264':
				return \XF::phrase('fs_yt_libx264_encoder_is_required_for_transcoding_video');
				break;

			case 'encoder_missing_audio':
				return \XF::phrase('fs_yt_aac_or_libvo_aacenc_encoder_is_required_for_transcoding_audio');
				break;

			case 'execute_error':
				return \XF::phrase('fs_yt_could_not_execute_ffmpeg_at_path_specified');
				break;
		}
	}
}