...
namespace FS\YtVideoSlider\Ffmpeg;
...
class Runner
{
	...
	{
		if ($validatePath) {
			/** @var \FS\YtVideoSlider\Validator\Ffmpeg $validator */
			$validator = \XF::app()->validator('FS\YtVideoSlider:Ffmpeg');
	...
	public function transcode()
	{
		if ($this->type == 'video') {
			if ($this->getEncoders('libvo_aacenc')) {
				...
				throw new \LogicException(\XF::phrase('fs_yt_videos_ffmpeg_has_access_to_neither_libvo_aacenc_codec_or_aac_codec'));
			}
