...
class TotalScoringSystem extends Entity
{

    public static function getStructure(Structure $structure)
    {
        $structure->table = 'fs_thread_total_scoring_system';
        $structure->shortName = 'FS\ThreadScoringSystem:TotalScoringSystem';
        $structure->contentType = 'fs_thread_total_scoring_system';
