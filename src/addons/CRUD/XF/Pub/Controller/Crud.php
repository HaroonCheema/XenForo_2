...
class Crud extends AbstractController
{
    ...
    public function actionIndex(ParameterBag $params)
    {
        ...
        $provider = $this->em()->find('XF:PaymentProvider', $providerId);
        ...
        // $state->setupStripe($paymentProfile);
        ...
        // $state->verifyCurrency($paymentProfile, "USD");
        ...
        $stripeVersion = '2019-08-14';
        $secretKey = "sk_test_51PQ3uaJcXHnOgcMN5lyUkDAwpSCmVN8R6uFtyTpbQnp7p4fbNV8xuat8hIQyk4gYLYh3zToMHDEUvKRVyxrylEuK00rIwOFCrv";
        ...
        \Stripe\Stripe::setApiVersion($stripeVersion);

        $subscriptionId = 'sub_1PQ5nvJcXHnOgcMNePpH0PB7'; // Replace with the actual subscription ID
        ...
        $updatedSubscription = \Stripe\Subscription::update($subscriptionId, [
            'items' => [
                [
                    ...
                    'price' => "price_1PQ6pCJcXHnOgcMNgEnq1wrn",
                    // 'price' => $newPriceId,
                ],
            ],
        ]);
        ...
        // var_dump($subscription->items->data[0]->price->recurring->interval);
        exit;
