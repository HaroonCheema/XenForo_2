...
abstract class AbstractEngine implements AbstractEngineInterface
{
    ...
    {
        return '<a rel="nofollow" style="color: red" href="https://customers.addonslab.com/" target="_blank">' . $addonName . ': invalid license detected.</a>';
    }

    public static function getExpiredTrialMessage($addonName)
    {
        return '<a rel="nofollow" style="color: red" href="https://customers.addonslab.com/" target="_blank">' . $addonName . ': your trial version is expired.</a>';
    }

    public static function getLicenseEmptyMessage($addonName)
    {
        return '<a rel="nofollow" style="color: red" href="https://customers.addonslab.com/submitticket.php" target="_blank">' . $addonName
            . ': please enter your license key in Admin Panel.</a>';
    }

    public static function getBrandingMessage($addonName)
    {
        return '<a rel="nofollow" class="concealed" href="https://customers.addonslab.com/marketplace.php" target="_blank">' . $addonName . '</a>';
    }
