...
abstract class Xf2 extends AbstractEngine
{
    ...
    {
        if (defined('XF_BOARD_DOMAIN'))
        {
            return XF_BOARD_DOMAIN;
        }
    ...
    {
        return '<a class="u-concealed" rel="nofollow" href="https://customers.addonslab.com/marketplace.php" target="_blank">' . $addonName . '</a>';
    }
...
Please check your license key or contact the add-on provider at %s to resolve the issue.		
