...
class Feature extends \XF\Admin\Controller\AbstractController
{
	...
	public function actionIndex(ParameterBag $params)
	{
		...
		return $this->view('EWR\Porta:Feature\List', 'EWRporta_feature_list', $viewParams);
	}
	...
	public function actionEdit(ParameterBag $params)
	{
		...
		return $this->view('EWR\Porta:Feature\Edit', 'EWRporta_feature_edit', $viewParams);
	}
	...
	public function actionSave(ParameterBag $params)
	{
		...
		{
			$this->getFeatureRepo()->setFeatureFromUpload($feature, $upload);
		}
		
		return $this->redirect($this->buildLink('ewr-porta/features'));
	}
	...
	public function actionDelete(ParameterBag $params)
	{
		...
		return $plugin->actionDelete(
			$feature,
			$this->buildLink('ewr-porta/features/delete', $feature),
			$this->buildLink('ewr-porta/features/edit', $feature),
			$this->buildLink('ewr-porta/features'),
	...
	{
		return $this->repository('EWR\Porta:Feature');
	}
}