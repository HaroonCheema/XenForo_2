...
namespace ThemeHouse\ThreadCredits\Option;

use XF\Option\AbstractOption;

class CreditPackage extends AbstractOption
{
	...
	{
		/** @var \ThemeHouse\ThreadCredits\Repository\CreditPackage $creditPackageRepo */
        $creditPackageRepo = \XF::repository('ThemeHouse\ThreadCredits:CreditPackage');

		$choices = $creditPackageRepo->getCreditPackageOptionsData(true, 'option');
