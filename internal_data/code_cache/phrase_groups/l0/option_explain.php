...
If you want to white list a domain\'s sub-domains and not the top level one, <b>add .domain.com.</b>',
  ...
  'option_explain.EWRporta_article_format' => 'Layout options only apply to threads formatted as articles.',
  'option_explain.EWRporta_article_forums' => '"Promote to article" will be checked on these forums when posting threads.',
  'option_explain.EWRporta_articles_permission' => 'Users will see all articles on the article lists, regardless of permissions.',
  'option_explain.EWRporta_articles_perpage' => 'The number of articles to display per page on article lists.',
  'option_explain.EWRporta_articles_prefill' => 'If disabled, thread content will be a placeholder only.',
  'option_explain.EWRporta_articles_stripbb' => 'Recommended to only use with "Strip line breaks" option.',
  'option_explain.EWRporta_articles_stripnl' => 'Text will be stripped of line breaks and appear as a paragraph.',
  'option_explain.EWRporta_articles_trim' => 'Excerpts will be trimmed if no [prebreak] is found. (0 to disable)',
  'option_explain.EWRporta_feature_dimensions' => 'Uploaded feature slider images will be resized DOWN to this maximum size.',
  'option_explain.EWRporta_header' => '',
  'option_explain.EWRporta_icon_external' => 'You probably don\'t want to use external images as your promotion icons.',
  'option_explain.EWRporta_metadesc' => 'Leave blank to use your XenForo board meta description.',
  'option_explain.EWRporta_navtab' => '',
  'option_explain.EWRporta_title' => 'Leave blank to use your XenForo board title.',
...
You should also provide the maximum video/audio file size in kilobytes (KB). Video/audio over this size will be rejected. The configuration of this server limits this value to <b>{serverMaxFileSize}</b> KB.',
  ...
  'option_explain.ca_applicable_forum' => 'Select forums for allowed attachment only in <b>first post</b>.',
...
Use 0 for whole number amounts.',
  ...
  'option_explain.dtDiscThreadUserId' => '',
  'option_explain.dtFirstPostMessage' => '',
  'option_explain.dtThreadTitlePrefix' => 'Please enter thread title prefixes to search for discussion thread, separated by commas',
  'option_explain.dtThreadTitlePrefixCreate' => 'Please enter a thread title prefix to create a new discussion thread.',
  'option_explain.dtUnreadPostLink' => '',
  'option_explain.dt_applicable_forums_discussion' => 'Select the forums on which latest discussions will be enabled',
...
This option requires that the specified account is a catch-all account or supports a "+" as a wildcard separator (such as in Gmail). For example, if this option is enabled with a bounce address of bounce@example.com, the email might be returned to bounce+123abc+user=domain.com@example.com.',
  ...
  'option_explain.fs_ca_atleast_attachment_forum' => 'Select forums where you want to required <b>atleast one attachment or media</b>.',
  'option_explain.fs_ca_exclude_forum' => 'Select forums for allowed <b>only text</b>.',
  ...
  'option_explain.fs_chat_gpt_api_key' => 'The key can be obtained on <a href="https://platform.openai.com/account/api-keys" target="_blank">OpenAI API keys</a> page.',
  ...
  'option_explain.fs_tbn_my_threads_specific_forum_id' => 'Select your specific forum here.',
...
Example: 1,2,3,4,..',
  ...
  'option_explain.fs_validate_email_api_key' => 'You can get api key from here <a href="https://app.emaillistverify.com/api" target="_blank">Email list verify</a>.',
...
Recommended: "1" Thumbnail -/- Max.: "4" Thumbnails',
  ...
  'option_explain.fspr_api_key' => 'Enter the Super API key obtained from your payment site.',
  'option_explain.fspr_payment_site_url' => 'Enter the base URL of your payment site',
  'option_explain.fspr_user_upgrade_ids' => 'Enter here main site user upgrade id and then this site user upgrade id like first enter main site id and then after : that this site user upgrade id. Example like 12:34,56:78,....',
...
/*$(function()
{
  ...
  'option_explain.nf_jb_baseurl' => 'Joomla base url , dont add the backslash at the end "/"',
  'option_explain.nf_jb_token' => '',
...
<b>You must run the "[OzzModz] Badges: Rebuild user badge cache" <a href="admin.php?tools/rebuild">rebuild cache job</a> to apply the changes.</b>',
  ...
  'option_explain.pp_applicable_forums' => 'Select the forums on which Multi Prefix will be work',
  'option_explain.pp_exclude_prefix' => 'Enter the ID of prefix that will not be display in Post Prefix dropdown (yon can enter multiple IDs separated by comma).',
  'option_explain.pp_videos_and_clips_ids' => 'Enter the IDs of the prefixes that will be displayed under the "Videos & Clips" post prefix dropdown (you can enter multiple IDs separated by commas).',
  ...
  'option_explain.reviewmapAutoRebuild' => 'If this option is enabled, the reviewmap will be rebuilt automatically periodically. If this option is disabled, the reviewmap will only be updated when it is rebuilt manually through <i>Tools &gt; Rebuild caches</i>. The current reviewmap can be accessed via <a href="reviewsmap.php">reviewsmap.php</a>.',
  'option_explain.reviewmapAutoSubmit' => 'Once a reviewmap is built, if this option is enabled, the updated version will be automatically submitted to the search engines specified. {$url} is replaced with your reviewmap URL automatically. If this option is not enabled, search engines will only know about the reviewmap if it is listed in robots.txt or if you manually submit it to them.',
  'option_explain.reviewmapExtraUrls' => 'If desired, you may include additional URLs that would not otherwise be included in the reviewmap. Place each URL on separate lines. Note that these URLs must match your board URL or they will not be included. Partial URLs will be converted to absolute URLs automatically.',
...
More details about the difference in models can be found at <a href="https://platform.openai.com/docs/models/overview">this link</a>.',
  ...
  'option_explain.siropuAdsManagerAccountSection' => 'If enabled, this option allows you to display the advertiser section menu in the user account section menu.',
  'option_explain.siropuAdsManagerAdActions' => 'If enabled, links for edit, delete, statistics, etc, will be displayed under the ad.',
  'option_explain.siropuAdsManagerAdBlock' => 'Choose what to do when your custom HTML/JavaScript ads are blocked by AdBlock. The last three options use the following phrases:  <b>siropu_ads_manager_support_us_message</b> and <b>siropu_ads_manager_support_us_title</b>',
  'option_explain.siropuAdsManagerAdBlockDevices' => 'This option allows you to enable AdBlock detection based on user\'s device.',
  'option_explain.siropuAdsManagerAdBlockDisplayAfterXPageViews' => 'This option allows you to display the notice after x page views.',
  'option_explain.siropuAdsManagerAdBlockDisplayInterval' => 'This option allows you to display the notice every x minutes.',
  'option_explain.siropuAdsManagerAdBlockExcludePages' => 'This option allows you exclude certain pages from AdBlock detection by specifying the page content template.',
  'option_explain.siropuAdsManagerAdBlockExcludeUserGroup' => 'Allows you to exclude certain user groups from AdBlock detection.',
  'option_explain.siropuAdsManagerAdBlockMessage' => 'This option allows you to display a custom message to users who have AdBlock enabled. You may use HTML.',
  'option_explain.siropuAdsManagerAdBlockRedirectUrl' => 'If an URL is provided, the user will get redirected to this URL when AdBlock is detected. This option only works with "Force user to disable AdBlock".',
  'option_explain.siropuAdsManagerAdCustomSizes' => 'A list of custom ad sizes that you can use when creating packages.',
  'option_explain.siropuAdsManagerAdParsingWhenPosting' => 'This option allows you to parse keyword and affiliate link ads when you post.',
  'option_explain.siropuAdsManagerAdminAlertNotification' => 'Admins will receive alert notifications when advertisers create ads.',
  'option_explain.siropuAdsManagerAdminEmailNotification' => 'Admins will receive email notifications when advertisers create ads.',
  'option_explain.siropuAdsManagerAdsPerPage' => 'This controls the maximum number of ads that will be shown in ad list.',
  'option_explain.siropuAdsManagerAdsTxt' => 'If you are using <a href="https://support.google.com/adsense/answer/7532444?hl=en" target="_blank">ads.txt</a> file, you can edit it from here.',
  'option_explain.siropuAdsManagerAdvertiserUserGroups' => 'This option allows you to add advertisers to custom user groups.',
  'option_explain.siropuAdsManagerAdvertisersPage' => 'If enabled, a list with all the active code, banner, text and link ads of the current advertisers will be displayed on a custom page.',
  'option_explain.siropuAdsManagerAdvertisersWidget' => 'If enabled, this option allows you to display a list of your current advertisers.',
  'option_explain.siropuAdsManagerAffiliateLinkThreadCustomFields' => 'This option allows you to enable affiliate link ads in thread custom fields.',
  'option_explain.siropuAdsManagerAllowedBannerTypes' => 'Select which extensions you want to allow for banner ads.',
  'option_explain.siropuAdsManagerAllowedFeaturedResourceCategories' => 'Select which categories you allow for featured resources.',
  'option_explain.siropuAdsManagerAllowedStickyForums' => 'Select which forums you allow for sticky threads.',
  'option_explain.siropuAdsManagerArchiveInactiveAds' => 'This option allows you to archive ads that haven\'t been active in the last x days. Archived ads will have the status "Archived" and won\'t be visible in the ACP by default.',
  'option_explain.siropuAdsManagerBannerDirName' => 'Some Ad Blockers may block the <b>siropu/am/user</b> path to the <b>data</b> directory on your server, preventing banners from displaying. To fix that problem, you can use this option to change the path from <b>siropu/am/user</b> to something unique (avoid ad related names such as "banners", "ads", etc).
<br>
<br>
Once you have provided a unique name and hit the save button, the directory will be created automatically and current banners copied from the old directory to the new directory.',
  'option_explain.siropuAdsManagerBodySelector' => 'The body selector specific to your style. You might need to change this if you are using a custom style with different selectors than the default style.',
  'option_explain.siropuAdsManagerClickCountCondition' => 'This option allows you to set a time frame between click counts for the same ad by the same visitor.',
  'option_explain.siropuAdsManagerClickFraudDeleteDaysOld' => 'This option allows you to automatically delete click fraud monitor entries that are older than x days. Set to 0 to disable it.',
  'option_explain.siropuAdsManagerClickFraudGlobalBlock' => 'This option allows you to hide from blocked IPs all the ads that use click fraud monitor.',
  'option_explain.siropuAdsManagerDeleteClickStats' => 'This option allows you to automatically delete ad click statistics that are older than x days. Set to 0 to disable it.',
  'option_explain.siropuAdsManagerDeleteDailyStats' => 'This option allows you to automatically delete ad daily statistics that are older than x days. Set to 0 to disable it.',
  'option_explain.siropuAdsManagerDisableLowCtrAds' => 'This option allows you to automatically disable ads with a low CTR (Click-Through Rate) after x days. This option only affects ads created from the admin control panel.',
  'option_explain.siropuAdsManagerDisallowedKeywords' => 'If you don\'t want advertisers to use certain keywords when creating keyword ads, place them here each on a new row.',
  'option_explain.siropuAdsManagerDisallowedTemplates' => 'You may want to prevent all ads from showing within certain templates, such as errors or other pages that may be against your ad provider\'s ToS. List them above.',
  'option_explain.siropuAdsManagerDisplayAdExpirationDate' => 'If enabled, this will display the expiration date in ad list',
  'option_explain.siropuAdsManagerDisplayAdOwner' => 'If enabled, this will display the username of the ad owner in ad list.',
  'option_explain.siropuAdsManagerEnableCustomThreadFields' => 'If enabled, advertisers will be able to set custom fields for their thread, based on the selected forum.',
  'option_explain.siropuAdsManagerEnableCustomThreadPrefix' => 'If enabled, advertisers will be able to set a prefix for their thread, based on the selected forum.',
  'option_explain.siropuAdsManagerEnabled' => 'Allow advertisers to buy ads.',
  'option_explain.siropuAdsManagerExpiredPromoThreadForum' => 'If a forum is set, expired promo threads will be moved to that forum.',
  'option_explain.siropuAdsManagerFeaturedResourcePrefix' => 'This option allows you to set a prefix for featured resources. You can use a global prefix because Ads Manager will reserve it only for featured resources and non-advertisers will not be able to use it.',
  'option_explain.siropuAdsManagerFeaturedResourcesWidget' => 'If enabled, this option allows you to display a list of your current featured resources.',
  'option_explain.siropuAdsManagerFeaturedThreadsWidget' => 'If enabled, this option allows you to display a list of your current sticky and promo threads.',
  'option_explain.siropuAdsManagerFooterSelector' => 'The footer selector specific to your style. You might need to change this if you are using a custom style with different selectors than the default style.',
  'option_explain.siropuAdsManagerForumMaxStickies' => 'The maximum number of stickies that can be purchased per forum.',
  'option_explain.siropuAdsManagerHomeMessage' => 'Display a welcome message to advertisers on the Ads Manager advertiser home page.',
  'option_explain.siropuAdsManagerInnerBodySelector' => 'The inner body selector specific to your style. You might need to change this if you are using a custom style with different selectors than the default style.',
  'option_explain.siropuAdsManagerInvoicePayTimeLimit' => 'The maximum time allowed to pay a pending invoice.',
  'option_explain.siropuAdsManagerJsFilePath' => 'Some Ad Blockers may block the <b>siropu/am/core.min.js</b> file found in the <b>js</b> directory on your server, preventing some features such as statistics from working. To fix that problem, you can use this option to change the directory path from <b>siropu/am/core.min.js</b> to something unique (avoid ad related names such as "banners", "ads", etc).
<br>
<br>
If you are not using an external path (CDN), the format should be: <b>directoryName/fileName.js</b>
<br>
<br>
Once you have provided a unique path and hit the save button, the directory will be created automatically and current JS file copied from the old directory to the new directory.',
  'option_explain.siropuAdsManagerKeywordDescription' => 'If a length is set, advertisers can add a description that will be displayed as a tooltip when hovering over the keywords. Set to 0 to disable descriptions.',
  'option_explain.siropuAdsManagerKeywordMaxWords' => 'The maximum number of words allowed in keyword phrase.',
  'option_explain.siropuAdsManagerKeywordThreadCustomFields' => 'This option allows you to enable keyword ads in thread custom fields.',
  'option_explain.siropuAdsManagerMaxAdDescriptionLength' => 'The maximum description length for text ads.',
  'option_explain.siropuAdsManagerMaxAdTitleLength' => 'The maximum title length allowed for link and text ads.',
  'option_explain.siropuAdsManagerMaxBgImageSize' => 'The maximum size in kilobytes allowed for background images.',
  'option_explain.siropuAdsManagerMaxImageSize' => 'The maximum size in kilobytes allowed for banner images.',
  'option_explain.siropuAdsManagerMaxPromoThreadStickies' => 'The maximum number of stickies that can be purchased per forum.',
  'option_explain.siropuAdsManagerMaxUserPromoThreads' => 'The maximum number of promo threads a user can purchase per forum.',
  'option_explain.siropuAdsManagerMenuLink' => 'If enabled, the link to the advertiser section will be displayed in the user drop down menu, instead of the main navigation.',
  'option_explain.siropuAdsManagerNodeIdNot' => 'This option allows you to globally hide ads in certain nodes, by adding each ID separated by comma.',
  'option_explain.siropuAdsManagerPageInfo' => 'If enabled, this will display the controller class, controller action, view class and the content template name of any page (to use in page criteria).',
  'option_explain.siropuAdsManagerPaymentInstructions' => 'This allows you to provide advertisers with custom payment instructions when using alternative payment options.',
  'option_explain.siropuAdsManagerPaymentProfiles' => 'Select which payment profiles you want to use.',
  'option_explain.siropuAdsManagerPlaceholderBgColor' => 'The background color of the banner placeholder for the "Advertise Here" package option.',
  'option_explain.siropuAdsManagerPlaceholderTextColor' => 'The text color of the banner placeholder for the "Advertise Here" package option.',
  'option_explain.siropuAdsManagerPositionVisualization' => 'If enabled, you can view where each position is displayed. This doesn\'t include dynamic positions and some predefined positions.',
  'option_explain.siropuAdsManagerPreferredCurrency' => 'Set your preferred currency for when creating packages and invoices.',
  'option_explain.siropuAdsManagerPromoThreadForums' => 'Select the forums for promo threads.',
  'option_explain.siropuAdsManagerPromoThreadPrefix' => 'This option allows you to set a default prefix for promo threads.',
  'option_explain.siropuAdsManagerSamBannerUnitCssClass' => 'The CSS class for banner ad units.',
  'option_explain.siropuAdsManagerSamCodeUnitCssClass' => 'The CSS class for code ad units.',
  'option_explain.siropuAdsManagerSamItemCssClass' => 'The CSS class for individual ads.',
  'option_explain.siropuAdsManagerSamLinkUnitCssClass' => 'The CSS class for link ad units.',
  'option_explain.siropuAdsManagerSamTextUnitCssClass' => 'The CSS class for text ad units.',
  'option_explain.siropuAdsManagerStickyThreadPrefix' => 'This option allows you to set a prefix for sticky threads. You can use a global prefix because Ads Manager will reserve it only for sticky threads and non-advertisers will not be able to use it.',
  'option_explain.siropuAdsManagerSubscriptions' => 'If enabled, advertisers can opt in for recurring payments.',
  'option_explain.siropuAdsManagerTermsAndConditions' => '(Optional) This option allows you to add special terms and conditions for advertisers. If provided, it will display a checkbox and a link with an overlay with the terms and conditions, on the ad creation page.',
  'option_explain.siropuAdsManagerThreadIdNot' => 'This option allows you to globally hide ads in certain threads, by adding each ID separated by comma.',
  'option_explain.siropuAdsManagerThreadPrefixNot' => 'This option allows you to globally hide ads in certain threads based on the prefix.',
  'option_explain.siropuAdsManagerUserGroupPostExceptions' => 'Keyword and affiliate link ads will not apply to posts made by users in the selected user groups.',
  'option_explain.siropuAdsManagerUserMaxStickies' => 'The maximum number of stickies a user can purchase per forum.',
  'option_explain.siropuAdsManagerViewCountCondition' => 'This option allows you to set a time frame between view counts for the same ad by the same visitor.',
  'option_explain.siropuAdsManagerViewCountMethod' => 'Select the method that will be used to count views.',
...
<li>The ‘All words’ option examines all the words in each possible tag and excludes tags which contain any of the words in the list.</li>
  ...
  'option_explain.th_keywordReplace' => 'This is a list of keywords or phrases that are to be replaced. If a replacement keyword or phrase is entered, the replacement text will be rewritten to this (for example, replacing "dog" with "cat").',
  'option_explain.th_keywordReplace_excludedUserGroups' => 'Any user groups selected here will be excluded from all keyword replacements entered above.',
  'option_explain.th_keywordReplace_limitPerPage' => 'Total number of keyword replacements to make per page, 0 for unlimited.',
  'option_explain.th_keywordReplace_limitPerWord' => 'Total number of keyword replacements to make per word, 0 for unlimited. This value is ignored if a limit is specified for an individual keyword.',
...
<b>Note</b>:  This does not apply to individual item maps.',
  ...
  'option_explain.xb_featureVideosLimit' => 'how many videos can be added as feature video',
  ...
  'option_explain.xc_hide_links_from_guests_allow_internal_img' => 'Allow internal image display to visitors.',
  'option_explain.xc_hide_links_from_guests_allow_internal_links' => 'Allow internal link display to visitors.',
  'option_explain.xc_hide_links_from_guests_anonym_url' => '',
  'option_explain.xc_hide_links_from_guests_atta_no_validated_email' => '',
  'option_explain.xc_hide_links_from_guests_enable_hide_attach' => 'Let hide attach to visitors or not',
  'option_explain.xc_hide_links_from_guests_enable_hide_image' => 'Let hide images to visitors or not',
  'option_explain.xc_hide_links_from_guests_enable_hide_link' => 'Let hide links to visitors or not',
  'option_explain.xc_hide_links_from_guests_enable_hide_media' => 'Let hide medias to visitors or not',
  'option_explain.xc_hide_links_from_guests_image_no_validated_email' => '',
  'option_explain.xc_hide_links_from_guests_img_websites_excluded' => 'Separate each site with a line break. Allows to display certain site (img) to the visitor.',
  'option_explain.xc_hide_links_from_guests_limit_insert_attach' => 'Maximum number of attachs to be replaced with the error. Within a post. after that the attach is only removed. 
0 = disabled',
  'option_explain.xc_hide_links_from_guests_limit_insert_image' => 'Maximum number of images to be replaced with the error. Within a post. after that the image is only removed. 
0 = disabled',
  'option_explain.xc_hide_links_from_guests_limit_insert_links' => 'Maximum number of links to be replaced with the error. Within a post. after that the link is only removed. 
0 = disabled',
  'option_explain.xc_hide_links_from_guests_limit_insert_media' => 'Maximum number of medias to be replaced with the error. Within a post. after that the media is only removed. 
0 = disabled',
  'option_explain.xc_hide_links_from_guests_media_no_validated_email' => '',
  'option_explain.xc_hide_links_from_guests_no_validated_email' => '',
  'option_explain.xc_hide_links_from_guests_websites_excluded' => 'Separate each site with a comma. Allows to display certain site (link) to the visitor.',
