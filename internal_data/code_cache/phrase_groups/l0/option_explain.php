...
Example: https://www.domain.com/members/',
  ...
  'option_explain.traktMovieThreads_apikey' => 'Enter your Trakt API key',
  'option_explain.traktTvThreads_aggregateCredits' => 'If checked, cast & crew data for TV shows will be fetched all the entire cast & crew for all episodes belonging to a TV show.</br>
This can be a large amount of data and will affect performance.',
  'option_explain.traktTvThreads_apikey' => 'Enter your API key for The Movie Database',
  'option_explain.traktTvThreads_backdropCoverSize' => 'Requires <a href="https://xenforo.com/community/resources/ozzmodz-covers.8589/" target="_blank">[OzzModz] Covers</a> add-on installed. Select "none" to disable. The file size of the selected option must not exceed the max. file cover size.',
  'option_explain.traktTvThreads_castsLimit' => '',
  'option_explain.traktTvThreads_category' => 'Categories selected in this list can only be used to create forums dedicated to individual TV shows.<br />Do not select any categories if you do not wish to use this option.',
  'option_explain.traktTvThreads_cdn_path' => 'If you are using your own CDN, enter the CDN path here.<br />Example: http://cdn.yourpath.com/data<br />DO NOT end the path with a /',
  'option_explain.traktTvThreads_changesLanguage' => 'Enter the ISO 639-1 Language Code that will be used for TV information.<br />These codes are available at <a href="http://en.wikipedia.org/wiki/List_of_ISO_639-1_codes" target="_blank">List of ISO 639-1 codes</a><br /><br />You may also include a two letter country code in the language selection (en-US, en-GB, pt-PT, pt-BR, etc...).<br />This is a list of the two letter country codes: <a href="https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2" target="_blank">ISO 3166-1 alpha-2 Country Codes</a><br /><br /><b>NOTE:</b> There is no guarantee that the translation to the language selected will be the proper translation. And there is no guarantee there will be a translation of a TV show at The Movie Database.',
  'option_explain.traktTvThreads_clientkey' => 'Enter your API key for Trakt Database',
  'option_explain.traktTvThreads_companiesLimit' => '',
  'option_explain.traktTvThreads_creditsLimit' => '',
  'option_explain.traktTvThreads_crosslink' => 'To place a redirect link to the main TV thread in all genre limited forums that a TV show can belong to, check this box. <font style="color:blue;">Genre limiting must be enabled for this to work</font><br />EXAMPLE: A TV show is in these genres: Drama, Science Fiction, Thriller<br />A member posts the show in the Science Fiction forum.<br />Redirect links will be placed in the Drama and Thriller forums.',
  'option_explain.traktTvThreads_episode_exclude' => 'Check this box to exclude the TV show title in the title for episode threads.<br />This may be needed if tv show names and episode titles exceed the XenForo thread title limit.',
  'option_explain.traktTvThreads_fetchCompanies' => 'Enable this option if you want to receive a list of TV companies. Enabling it can slow down the thread creation process.',
  'option_explain.traktTvThreads_fetchCredits' => 'Enable this option if you want to receive a list of TV credits. Enabling it can slow down the thread creation process.',
  'option_explain.traktTvThreads_fetchNetworks' => 'Enable this option if you want to receive a list of TV networks. Enabling it can slow down the thread creation process.',
  'option_explain.traktTvThreads_fetchVideos' => 'Enable this option if you want to receive a list of TV videos. Enabling it can slow down the thread creation process.',
  'option_explain.traktTvThreads_force_comments' => 'Check this box if you want to force any comments entered with a new TV thread to be posted as the second post in the new TV thread.<br /><b>NOTE:</b> This does not change existing threads. This only affects the first post in a new TV thread.',
  'option_explain.traktTvThreads_language' => 'Enter the ISO 639-1 Language Code that will be used for TV information.<br />These codes are available at <a href="http://en.wikipedia.org/wiki/List_of_ISO_639-1_codes" target="_blank">List of ISO 639-1 codes</a><br /><br />You may also include a two letter country code in the language selection (en-US, en-GB, pt-PT, pt-BR, etc...).<br />This is a list of the two letter country codes: <a href="https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2" target="_blank">ISO 3166-1 alpha-2 Country Codes</a><br /><br /><b>NOTE:</b> There is no guarantee that the translation to the language selected will be the proper translation. And there is no guarantee there will be a translation of a TV show at The Movie Database. Those are both handled by The Movie Database and not translated by this add-on.<br /><br />Changing language will NOT change threads already posted. Only new threads will post in the new language.',
  'option_explain.traktTvThreads_largeCompanyLogoSize' => 'This setting affects the size of files on the system.',
  'option_explain.traktTvThreads_largeNetworkLogoSize' => 'This setting affects the size of files on the system.',
  'option_explain.traktTvThreads_largePosterSize' => 'Changing this value will only apply to new entries. Larger values will take up more space and take longer to download.',
  'option_explain.traktTvThreads_multiple' => 'Check this box to allow a TV show to be posted more than once.',
  'option_explain.traktTvThreads_networksLimit' => '',
  'option_explain.traktTvThreads_replaceSearchTemplate' => 'Check this option if you want to display TV data in XF search/tag results.',
  'option_explain.traktTvThreads_showThread' => 'Select the items to be shown in the first post of a TV thread',
  'option_explain.traktTvThreads_smallCompanyLogoWidth' => 'This setting affects the size of files on the system.',
  'option_explain.traktTvThreads_smallNetworkLogoWidth' => 'This setting affects the size of files on the system.',
  'option_explain.traktTvThreads_smallPosterWidth' => 'Changing this value will only apply to new entries. Larger values will take up more space.',
  'option_explain.traktTvThreads_sort' => 'The default sort order when a new season forum is created is descending. To sort them in ascending order, check this box.',
  'option_explain.traktTvThreads_syncTitle' => '',
  'option_explain.traktTvThreads_threadListInfo' => 'Select the items to show in the forum thread list',
  'option_explain.traktTvThreads_titleYear' => 'To include the year a TV show was released in the thread title, check this box.<br />
Example: Flash (2014)',
  'option_explain.traktTvThreads_trackChanges' => 'Enable if you want to keep track of the list of changed TVs to automatically apply rebuilding data.</br>
<b>Note: </b> This will overwrite all your manual edits if the TV has been updated.',
  'option_explain.traktTvThreads_trackChangesAiringToday' => 'This will help to keep track of last-aired data changes since the <a href="https://developers.themoviedb.org/3/changes/get-movie-change-list">/movie/changes</a> endpoint doesn\'t report added episodes.<br/>
<b>Note:</b> This will overwrite all your manual edits if the TV has been updated.',
  'option_explain.traktTvThreads_trackChangesPeriod' => 'You can query up to 14 days',
  'option_explain.traktTvThreads_useLocalImages' => 'Store the poster images stored directly on your server. If not, TMDb image links will be used to display.',
  'option_explain.traktTvThreads_use_genres' => 'You can limit the type of TV shows posted in each forum to a specific genre. Check this box to enable this option. The genre for each forum is specified in Forums->Nodes. Click on the forum you wish to limit and select the genres you wish to allow in the forum.',
  'option_explain.traktTvThreads_use_rating' => 'Check this box to turn on the TV show rating system.',
  'option_explain.traktTvThreads_usecdn' => 'Check this box to use your own CDN for all poster images.',
  'option_explain.traktTvThreads_videosLimit' => '',
  'option_explain.traktTvThreads_watchProviderRegion' => '',
  'option_explain.traktTvThreads_watchProviderRegions' => 'Leave it empty to disable.<br />
Phrases can be translated with "snog_tv_country.{countryCode}" key.',
  'option_explain.traktthreads_apikey' => '',
  'option_explain.traktthreads_backdropCoverSize' => 'Requires <a href="https://xenforo.com/community/resources/ozzmodz-covers.8589/" target="_blank">[OzzModz] Covers</a> add-on installed. Select "none" to disable. The file size of the selected option must not exceed the max. file cover size.',
  'option_explain.traktthreads_castsLimit' => '',
  'option_explain.traktthreads_cdn_path' => 'If you are using your own CDN, enter the CDN path here.<br />Example: http://cdn.yourpath.com/data<br />DO NOT end the path with a /',
  'option_explain.traktthreads_changesLanguage' => 'Enter the ISO 639-1 Language Code that will be used for movie information.<br />These codes are available at <a href="http://en.wikipedia.org/wiki/List_of_ISO_639-1_codes" target="_blank">List of ISO 639-1 codes</a><br /><br />You may also include a two letter country code in the language selection (en-US, en-GB, pt-PT, pt-BR, etc...).<br />This is a list of the two letter country codes: <a href="https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2" target="_blank">ISO 3166-1 alpha-2 Country Codes</a><br /><br /><b>NOTE:</b> There is no guarantee that the translation to the language selected will be the proper translation. And there is no guarantee there will be a translation of a movie at The Movie Database. Those are both handled by The Movie Database and not translated by this add-on.<br />',
  'option_explain.traktthreads_companiesLimit' => '',
  'option_explain.traktthreads_crewLimit' => '',
  'option_explain.traktthreads_crosslink' => 'To place a redirect link to the main movie thread in all genre limited forums that a movie can belong to, check this box.<br />EXAMPLE: A movie is in these genres: Drama, Science Fiction, Thriller<br />A member posts the movie in the Science Fiction forum.<br />Redirect links will be placed in the Drama and Thriller forums.<br /><b>NOTE: </b>Forum genre limiting must be enabled for this to work',
  'option_explain.traktthreads_fetchCompanies' => 'Enable this option if you want to receive a list of movie companies. Enabling it can slow down the thread creation process.',
  'option_explain.traktthreads_fetchCredits' => 'Enable this option if you want to receive a list of movie credits. Enabling it can slow down the thread creation process.',
  'option_explain.traktthreads_fetchVideos' => 'Enable this option if you want to receive a list of movie videos. Enabling it can slow down the thread creation process.',
  'option_explain.traktthreads_force_comments' => 'Check this box if you want to force any comments entered with a new movie thread to be posted as the second post in the new movie thread. NOTE: This does not change existing threads. This only affects the first post in a new movie thread.',
  'option_explain.traktthreads_forum_local' => 'Instead of using the TMDb cloud for poster images, you can use the poster images that are stored on your server. To use the images stored on your server, check this box.',
  'option_explain.traktthreads_language' => 'Enter the ISO 639-1 Language Code that will be used for movie information.<br />These codes are available at <a href="http://en.wikipedia.org/wiki/List_of_ISO_639-1_codes" target="_blank">List of ISO 639-1 codes</a><br /><br />You may also include a two letter country code in the language selection (en-US, en-GB, pt-PT, pt-BR, etc...).<br />This is a list of the two letter country codes: <a href="https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2" target="_blank">ISO 3166-1 alpha-2 Country Codes</a><br /><br /><b>NOTE:</b> There is no guarantee that the translation to the language selected will be the proper translation. And there is no guarantee there will be a translation of a movie at The Movie Database. Those are both handled by The Movie Database and not translated by this add-on.<br /><br />Changing language will NOT change threads already posted. Only new threads will post in the new language.',
  'option_explain.traktthreads_largeCompanyLogoSize' => '',
  'option_explain.traktthreads_largePosterSize' => 'Changing this value will only apply to new entries. Larger values will take up more space and take longer to download.',
  'option_explain.traktthreads_replaceSearchTemplate' => 'Check this option if you want to display movie data in XF search/tag results.',
  'option_explain.traktthreads_showThreadInfo' => 'Select the items to show in a movie thread.',
  'option_explain.traktthreads_smallCompanyLogoWidth' => 'Changing this value will only apply to new entries. Larger values will take up more space and take longer to resize.',
  'option_explain.traktthreads_smallPosterWidth' => 'Changing this value will only apply to new entries. Larger values will take up more space and take longer to resize.',
  'option_explain.traktthreads_syncTitle' => '',
  'option_explain.traktthreads_threadListInfo' => 'Select the items to show in the forum thread list.',
  'option_explain.traktthreads_trackChanges' => 'Enable if you want to keep track of the list of changed TVs to automatically apply rebuilding data.
<b>Note:</b> This will overwrite all your manual edits if the TV has been updated.',
  'option_explain.traktthreads_trackChangesPeriod' => 'You can query up to 14 days',
  'option_explain.traktthreads_use_genres' => 'You can limit the type of movies posted in each forum to a specific genre. Check this box to enable this option. The genre for each forum is specified in Forums->Nodes. Click on the forum you wish to limit and select the genres you wish to allow in the forum.',
  'option_explain.traktthreads_use_rating' => 'Check this box to turn on the movie rating system.',
  'option_explain.traktthreads_usecdn' => 'Check this box to use your own CDN for all poster images. Your CDN must pick up images from your server\'s data/movies folder.',
  'option_explain.traktthreads_useyear' => 'To include the year a movie was released in the thread title, check this box.<br />Example: Blended (2014)',
  'option_explain.traktthreads_videoLimit' => '',
  'option_explain.traktthreads_watchProviderRegion' => '',
  'option_explain.traktthreads_watchProviderRegions' => 'Leave it empty to disable.<br />
Phrases can be translated with "snog_movies_country.{countryCode}" key.',
