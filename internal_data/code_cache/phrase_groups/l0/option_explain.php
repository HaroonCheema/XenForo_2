...
Use the textbox above to specify a format. <b>{title}</b> will be replaced with the fetched page title and <b>{url}</b> will be replaced with the original URL. If no format is entered, the title itself will be displayed.',
  ...
  'option_explain.xc_hide_link_from_guests_allowed_nodes' => 'Select the forums where the links will be visible.',
  'option_explain.xc_hide_link_from_guests_attach_allowed_nodes' => 'Select the forums where the images attach will be visible',
  'option_explain.xc_hide_link_from_guests_image_allowed_nodes' => 'Select the forums where the images will be visible.',
  'option_explain.xc_hide_link_from_guests_media_allowed_nodes' => 'Select the forums where the medias will be visible.',
