...
Use the textbox above to specify a format. <b>{title}</b> will be replaced with the fetched page title and <b>{url}</b> will be replaced with the original URL. If no format is entered, the title itself will be displayed.',
  ...
  'option_explain.zoom_meeting_access_token' => 'Do not need to change or insert any thing.',
  'option_explain.zoom_meeting_client_id' => '',
  'option_explain.zoom_meeting_client_secret' => '',
  'option_explain.zoom_meeting_refresh_token' => 'Do not need to change or insert any thing.',
);