<?php
// FROM HASH: 15f3416cb25145774d47979dda76633f
return array(
...
.message-movie
{
	...
	{
		flex: 1;
		width: @xf-trakt_moviesMessageSidebarWidth;
		...
		.movie-poster
		{
			padding-bottom: 10px;
			img {
				max-width: @xf-trakt_moviesMessagePosterMaxWidth;
			}
		}
	}
	...
	.movie-company img
	{
		height: @xf-trakt_movies_productionCompanyImgHeight;
		width: @xf-trakt_movies_productionCompanyImgWidth;
	}
}
...
.moviePoster {
	margin-top:5px;
	width: @xf-trakt_movies_posterImageWidth;
	height: @xf-trakt_movies_posterImageHeight;
	position: relative;
}
