<?php
// FROM HASH: 616559df1a20e1a1233f526319c57afe
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
		if ($__templater->method($__vars['post'], 'canEdit', array())) {
			$__finalCompiled .= '
		';
			if (($__templater->method($__vars['xf']['visitor'], 'hasPermission', array('forum', 'trakt_edit_shows', )) AND (!$__vars['thread']['TV']['comment'])) OR $__vars['thread']['TV']['comment']) {
				$__finalCompiled .= '
			';
