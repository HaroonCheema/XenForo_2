	...
	<div class="block-row block-row--separated">
		<div class="contentRow movieTab--casts">
			<span class="contentRow-figure contentRow-figure--fixedMedium contentRow-figure--fixedMedium contentRow-figure--fluidWidth">
				<img src="' . ($__templater->escape($__vars['cast']['Person']['image_url']) ?: $__templater->func('base_url', array($__templater->func('property', array('trakt_tv_castPersonSmallImageUrl', ), false), ), true)) . '" />
			</span>
	...
	if ($__vars['cast']['roles']) {
		...
		if ($__templater->isTraversable($__vars['cast']['roles'])) {
			foreach ($__vars['cast']['roles'] AS $__vars['role']) {
				$__finalCompiled .= '
								<li>' . $__templater->escape($__vars['role']['character']) . ' (' . 'trakt_tv_x_episodes' . ')</li>
							';
			}
		}
		$__finalCompiled .= '
