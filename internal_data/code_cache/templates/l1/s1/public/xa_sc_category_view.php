<?php
// FROM HASH: f41d981dc2dba98f18351b4965f02a14
return array(
...
';
	...
	' . $__templater->button(($__vars['category']['content_term'] ? 'Add ' . $__templater->escape($__vars['category']['content_term']) . '' : 'Add spa'), array(
