<?php
// FROM HASH: 2a9e617c1062abcae2c7a94e057f4ea6
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__finalCompiled .= '
	<ul class="listPlain listColumns listColumns--3 listColumns--spaced js-movieCrewList' . $__templater->escape($__vars['movie']['trakt_id']) . '">
		';
	...
	if ($__vars['hasMore']) {
		$__finalCompiled .= '
		<div class="block-footer js-movieCrewLoadMore' . $__templater->escape($__vars['movie']['trakt_id']) . '">
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['crew']['Person']['image_url']) {
		...
		$__finalCompiled .= '
					<img src="' . $__templater->func('base_url', array($__templater->func('property', array('trakt_movies_crewPersonSmallImageUrl', ), false), ), true) . '" />
				';
	}
	$__finalCompiled .= '
			</span>
