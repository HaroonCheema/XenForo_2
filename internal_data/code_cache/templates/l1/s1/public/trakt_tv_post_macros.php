...
'watch_providers' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['watchProviders']) {
		...
		$__finalCompiled .= $__templater->formSelect(array(
			'value' => ($__vars['xf']['visitor']['Option']['nick97_tv_trakt_watch_region'] ?: $__vars['xf']['options']['traktTvThreads_watchProviderRegion']),
		), $__compilerTemp1) . '
														</div>
													</h4>
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<article class="message message--tv js-post js-inlineModContainer
		...
		'thread' => $__vars['thread'],
							...
							<div class="message-content js-messageContent">
								' . '
								<div class="message-tv' . (($__templater->func('property', array('trakt_tv_messagePosterPosition', ), false) == 'right') ? ' message-tv--reverse' : '') . '">
	...
	$__finalCompiled .= '
											...
											';
	if ($__vars['xf']['options']['traktTvThreads_use_rating']) {
		$__finalCompiled .= '
	...
	$__finalCompiled .= '
										...
										';
	if (($__templater->func('property', array('trakt_tv_messageCompaniesPosition', ), false) == 'left')) {
		$__finalCompiled .= '
											';
		if (!$__templater->test($__vars['companies'], 'empty', array())) {
			$__finalCompiled .= '
												<div class="messageTV tv-companies">
													';
			if ($__templater->func('property', array('trakt_tv_messageCompaniesTitle', ), false)) {
				$__finalCompiled .= '
														<h4 class="block-textHeader">' . 'trakt_tv_production_companies:' . '</h4>
													';
			}
			$__finalCompiled .= '
	...
	$__finalCompiled .= '
										...
										';
	if (($__templater->func('property', array('trakt_tv_messageNetworksPosition', ), false) == 'left')) {
		$__finalCompiled .= '
											';
		if (!$__templater->test($__vars['networks'], 'empty', array())) {
			$__finalCompiled .= '
												<div class="messageTV tv-networks">
													';
			if ($__templater->func('property', array('trakt_tv_messageNetworksTitle', ), false)) {
				$__finalCompiled .= '
														<h4 class="block-textHeader">' . 'trakt_tv_networks:' . '</h4>
													';
			}
			$__finalCompiled .= '
	...
	if ($__vars['post']['TVPost']) {
		...
		if ($__vars['post']['TVPost']['tv_title']) {
			$__finalCompiled .= '
													...
													<b>' . 'trakt_tv_season' . ':</b> <meta itemprop="partOfSeason" content="' . $__templater->escape($__vars['post']['TVPost']['tv_season']) . '">' . $__templater->escape($__vars['post']['TVPost']['tv_season']) . '<br />
													<b>' . 'trakt_tv_episode' . ':</b> <meta itemprop="episodeNumber" content="' . $__templater->escape($__vars['post']['TVPost']['tv_episode']) . '">' . $__templater->escape($__vars['post']['TVPost']['tv_episode']) . '<br />
													<b>' . 'trakt_tv_air_date' . ':</b> <meta itemprop="datePublished" content="' . $__templater->escape($__vars['post']['TVPost']['tv_aired']) . '">' . $__templater->escape($__vars['post']['TVPost']['tv_aired']) . '<br /><br />
													';
			if ($__vars['post']['TVPost']['tv_guest']) {
				$__finalCompiled .= '<b>' . 'trakt_tv_guest_stars' . ': </b>' . $__templater->escape($__vars['post']['TVPost']['tv_guest']) . '<br />';
			}
			$__finalCompiled .= '
												';
			...
			$__finalCompiled .= '
													...
													<b>' . 'trakt_tv_season' . ':</b> <meta itemprop="partOfSeason" content="' . $__templater->escape($__vars['post']['Thread']['TV']['tv_season']) . '">' . $__templater->escape($__vars['post']['Thread']['TV']['tv_season']) . '<br />
													<b>' . 'trakt_tv_episode' . ':</b> <meta itemprop="episodeNumber" content="' . $__templater->escape($__vars['post']['Thread']['TV']['tv_episode']) . '">' . $__templater->escape($__vars['post']['Thread']['TV']['tv_episode']) . '<br />
													<b>' . 'trakt_tv_air_date' . ':</b> <meta itemprop="datePublished" content="' . $__templater->escape($__vars['post']['Thread']['TV']['tv_release']) . '">' . $__templater->escape($__vars['post']['Thread']['TV']['tv_release']) . '<br /><br />
													';
			if ($__vars['post']['Thread']['TV']['tv_cast']) {
				$__finalCompiled .= '<b>' . 'trakt_tv_guest_stars' . ': </b>' . $__templater->escape($__vars['post']['Thread']['TV']['tv_cast']) . '<br />';
			}
			$__finalCompiled .= '
												';
		}
	...
	$__finalCompiled .= '
										...
										';
	if (($__templater->func('property', array('trakt_tv_messageCompaniesPosition', ), false) == 'right')) {
		$__finalCompiled .= '
											';
		if (!$__templater->test($__vars['companies'], 'empty', array())) {
			$__finalCompiled .= '
	...
	$__finalCompiled .= '
										...
										';
	if (($__templater->func('property', array('trakt_tv_messageNetworksPosition', ), false) == 'right')) {
		$__finalCompiled .= '
											';
		if (!$__templater->test($__vars['networks'], 'empty', array())) {
			$__finalCompiled .= '
	...
	$__compilerTemp1 .= '
												' . '
												';
	if ($__vars['xf']['options']['traktTvThreads_showThread']['cast_tab'] AND !$__templater->test($__vars['casts'], 'empty', array())) {
		$__compilerTemp1 .= '
	...
	$__compilerTemp1 .= '
												' . '
												';
	if ($__vars['xf']['options']['traktTvThreads_showThread']['crew_tab'] AND !$__templater->test($__vars['crews'], 'empty', array())) {
		$__compilerTemp1 .= '
	...
	$__compilerTemp1 .= '
												' . '
												';
	if ($__vars['xf']['options']['traktTvThreads_showThread']['videos_tab'] AND !$__templater->test($__vars['videos'], 'empty', array())) {
		$__compilerTemp1 .= '
													<a class="tabs-tab" role="tab" tabindex="0" aria-controls="tv-crew">
														' . 'Videos' . '
													</a>
			...
			<li>
				<div class="listHeap-iconContainer">
					<a class="tv-provider" data-xf-init="tooltip" title="' . $__templater->escape($__vars['watchProvider']['provider_name']) . '">
						<img src="https://www.themoviedb.org/t/p/original/' . $__templater->escape($__vars['watchProvider']['logo_path']) . '" width="' . $__templater->func('property', array('trakt_tv_watchProviderImgSize', ), true) . '" height="' . $__templater->func('property', array('trakt_tv_watchProviderImgSize', ), true) . '"> 
					</a>
				</div>
			</li>
		';
