<?php
// FROM HASH: 4fe8595aa1f8ecf72bdf240ab35e82a3
return array(
...
,array(
	...
	array(
		...
		'label' => 'spa that have been rated',
		'_type' => 'option',
	),
	array(
		'name' => 'has_reviews',
		'selected' => $__vars['filters']['has_reviews'],
		'label' => 'spa with reviews',
		'_type' => 'option',
	),
	array(
		'name' => 'has_comments',
		'selected' => $__vars['filters']['has_comments'],
		'label' => 'spa with comments',
		'_type' => 'option',
	))) . '
	</div>
	...
	' . '
	<div class="menu-row menu-row--separated">
		' . 'spa that mention' . $__vars['xf']['language']['label_separator'] . '
		<div class="u-inputSpacer">
			' . $__templater->formTextBox(array(
		'name' => 'term',
...
', array(
		'action' => $__templater->func('link', array('showcase/categories/map-filters', $__vars['category'], ), false),
	));
