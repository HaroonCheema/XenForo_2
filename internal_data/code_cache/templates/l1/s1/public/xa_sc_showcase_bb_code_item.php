<?php
// FROM HASH: 19d43a4be82e6764ea16b4058789289a
return array(
...
<div class="embeddedScItem block--messages">
	<div class="block-row block-row--separated" data-author="' . ($__templater->escape($__vars['item']['User']['username']) ?: $__templater->escape($__vars['item']['username'])) . '">
		<div class="contentRow scItemSearchResultRow">
			';
	if ($__vars['item']['cover_image_id'] OR $__vars['item']['Category']['content_image_url']) {
		$__finalCompiled .= '
		...
		if ($__vars['item']['cover_image_id']) {
			...
			$__finalCompiled .= '
						<a href="' . $__templater->func('link', array('ams', $__vars['item'], ), true) . '">
