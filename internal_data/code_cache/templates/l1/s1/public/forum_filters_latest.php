<?php
// FROM HASH: 01259809bba8f21f6f05acda6eec8bf3
return array(
...
';
	...
	' . $__templater->formSelect(array(
		'name' => 'thread_fields[__node_ids]',
		'value' => ($__vars['filterSet']['__node_ids'] ?: array()),
		'multiple' => true,
	...
	array(
	 ...
	 <div class="menu-row menu-row--separated">
		...
		<div class="menu-row menu-row--separated">
			...
			<div class="u-inputSpacer">
	' . $__templater->formSelect(array(
		'name' => 'thread_fields[__prefix_ids1]',
		'value' => ($__vars['filterSet']['__prefix_ids1'] ?: array()),
		'multiple' => true,
		'class' => 'input js-example-basic-single',
		'title' => 'Prefix',
	), $__compilerTemp4) . '
	...
	<div class="menu-row menu-row--separated">
			...
			<div class="u-inputSpacer">
	' . $__templater->formSelect(array(
		'name' => 'thread_fields[__prefix_ids2]',
		'value' => ($__vars['filterSet']['__prefix_ids2'] ?: array()),
		'multiple' => true,
		'class' => 'input js-example-basic-single',
		'title' => 'Prefix',
	), $__compilerTemp6) . '
	...
	<div class="menu-row menu-row--separated">
			...
			<div class="u-inputSpacer">
	' . $__templater->formSelect(array(
		'name' => 'thread_fields[__prefix_ids3]',
		'value' => ($__vars['filterSet']['__prefix_ids3'] ?: array()),
		'multiple' => true,
		'class' => 'input js-example-basic-single',
		'title' => 'Prefix',
	), $__compilerTemp8) . '
