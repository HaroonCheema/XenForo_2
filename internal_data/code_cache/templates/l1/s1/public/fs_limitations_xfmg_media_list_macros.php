<?php
// FROM HASH: 911e15191122132d38c2c292af3d6141
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__finalCompiled .= '
	<div class="itemList-item js-inlineModContainer' . ($__templater->method($__vars['mediaItem'], 'isIgnored', array()) ? ' is-ignored' : '') . '" style="width: 150px" data-author="' . ($__templater->escape($__vars['mediaItem']['User']['username']) ?: $__templater->escape($__vars['mediaItem']['username'])) . '">
		';
