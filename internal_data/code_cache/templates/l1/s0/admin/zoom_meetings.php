<?php
// FROM HASH: e541b3143420b4c6dd15ba92b6f83d8a
return array(
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Meeting list');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
	' . $__templater->button('Add Meeting', array(
		'href' => $__templater->func('link', array('meetings/add', ), false),
		'icon' => 'user',
	), '', array(
	)) . '
');
		...
		if ($__templater->isTraversable($__vars['meetings'])) {
			foreach ($__vars['meetings'] AS $__vars['meeting']) {
				...
				array(
					...
					'targclass' => 'js-startUrl' . $__vars['meeting']['meeting_id'],
				), $__vars),
				),
				array(
					'_type' => 'cell',
				...
				array(
					'href' => $__templater->func('link', array('meetings/edit', $__vars['meeting'], ), false),
					'_type' => 'action',
					'html' => 'Edit',
				),
				array(
	...
	', array(
			'action' => $__templater->func('link', array('meetings/toggle', ), false),
			'class' => 'block',
			'ajax' => 'true',
		)) . '
		';
