<?php
// FROM HASH: a609d38a10b7eab5f0212fac8a706e36
return array(
...
';
	...
	' . $__templater->button('Add keyword', array(
		'href' => $__templater->func('link', array('thmonetize-keywords/add', ), false),
		'icon' => 'add',
	), '', array(
	)) . '
');
...
';
		...
		if ($__templater->isTraversable($__vars['keywords'])) {
			foreach ($__vars['keywords'] AS $__vars['keyword']) {
				$__compilerTemp1 .= '
					...
					'href' => $__templater->func('link', array('thmonetize-keywords/edit', $__vars['keyword'], ), false),
					'delete' => $__templater->func('link', array('thmonetize-keywords/delete', $__vars['keyword'], ), false),
				), array(array(
	...
	', array(
			'action' => $__templater->func('link', array('thmonetize-keywords/toggle', ), false),
			'class' => 'block',
			'ajax' => 'true',
		)) . '
';
