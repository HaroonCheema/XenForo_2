<?php
// FROM HASH: ade4b6ef803dbbc9e8acfc488596fd24
return array(
...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->func('link', array('referral-system/reward-types/delete', $__vars['rewardType'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
';
	...
	' . $__compilerTemp3 . '
', array(
		'action' => $__templater->func('link', array('referral-system/reward-types/save', $__vars['rewardType'], ), false),
		'upload' => 'true',
		'ajax' => 'true',
		'class' => 'block',
	));
