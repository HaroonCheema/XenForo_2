<?php
// FROM HASH: edb587eb4839d0c88f7a94bca4eda5c6
return array(
...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->func('link', array('referral-system/tools/delete', $__vars['tool'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
';
	...
	' . $__compilerTemp2 . '
', array(
		'action' => $__templater->func('link', array('referral-system/tools/save', $__vars['tool'], ), false),
		'upload' => 'true',
		'ajax' => 'true',
		'class' => 'block',
	));
