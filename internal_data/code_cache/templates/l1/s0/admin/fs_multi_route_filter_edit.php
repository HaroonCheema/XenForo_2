<?php
// FROM HASH: ea3d7a78ca72fa6b890ddc8ef55728a0
return array(
...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->func('link', array('multi-route-filters/delete', $__vars['routeFilter'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
', array(
		'action' => $__templater->func('link', array('multi-route-filters/save', $__vars['routeFilter'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
