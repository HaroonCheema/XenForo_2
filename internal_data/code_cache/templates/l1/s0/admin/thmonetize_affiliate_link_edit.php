<?php
// FROM HASH: 43efe282ea4025e0facdb9408896a41c
return array(
...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->func('link', array('thmonetize-affiliate-links/delete', $__vars['affiliateLink'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
		...
		<h2 class="block-tabHeader tabs hScroller" data-xf-init="tabs h-scroller" role="tablist">
			<span class="hScroller-scroll">
				<a class="tabs-tab is-active" role="tab" tabindex="0"
				   aria-controls="general-options">' . 'General options' . '</a>
				<a class="tabs-tab" role="tab" tabindex="1"
				   aria-controls="link-criteria">' . 'Link criteria' . '</a>
...
', array(
		'action' => $__templater->func('link', array('thmonetize-affiliate-links/save', $__vars['affiliateLink'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
