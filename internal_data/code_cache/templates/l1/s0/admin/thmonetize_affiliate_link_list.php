<?php
// FROM HASH: dec1ff2b4b3dacc210ac18726da97ef4
return array(
...
';
	...
	' . $__templater->button('
		' . 'Add affiliate link' . '
	', array(
		'href' => $__templater->func('link', array('thmonetize-affiliate-links/add', ), false),
		'icon' => 'add',
	), '', array(
	)) . '
');
...
';
		...
		if ($__templater->isTraversable($__vars['affiliateLinks'])) {
			foreach ($__vars['affiliateLinks'] AS $__vars['affiliateLink']) {
				$__compilerTemp1 .= '
					...
					'href' => $__templater->func('link', array('thmonetize-affiliate-links/edit', $__vars['affiliateLink'], ), false),
					'delete' => $__templater->func('link', array('thmonetize-affiliate-links/delete', $__vars['affiliateLink'], ), false),
				), array(array(
	...
	', array(
			'action' => $__templater->func('link', array('thmonetize-affiliate-links/toggle', ), false),
			'class' => 'block',
			'ajax' => 'true',
		)) . '
';
