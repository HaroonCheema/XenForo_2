<?php
// FROM HASH: 40a780a3434003fe1d006f33f2202fbd
return array(
		...
		if ($__templater->isTraversable($__vars['threads'])) {
			foreach ($__vars['threads'] AS $__vars['thread']) {
				...
				$__compilerTemp2[] = array(
					...
					'href' => $__templater->func('link', array('members', $__vars['thread']['LastPoster'], ), false),
					'_type' => 'cell',
					'html' => '
				...
				$__compilerTemp2[] = array(
					...
					'href' => ($__templater->method($__vars['thread'], 'isUnread', array()) ? $__templater->func('link', array('threads/unread', $__vars['thread'], ), false) : $__templater->func('link', array('threads/post', $__vars['thread'], array('post_id' => $__vars['thread']['last_post_id'], ), ), false)),
					'_type' => 'cell',
					'html' => '
				...
				$__compilerTemp2[] = array(
					'class' => 'dataList-cell--min dataList-cell--alt dataList-cell--forumStats-date',
					'_type' => 'cell',
					'html' => '
                        <div class="miniCol">
