...
}' . $__templater->includeTemplate('dbtech_ecommerce_core.less', $__vars) . $__templater->includeTemplate('core_xfmg.less', $__vars) . $__templater->includeTemplate('core_xfrm.less', $__vars);
