<?php
// FROM HASH: fc007f91461f5d9fae41594047050e66
return array(
	...
	<div class="block">
			...
			<div class="block-body">
				<div class="block-row block-row--separated">
					<dl class="pairs pairs--columns pairs--fixedSmall">
						<dt>' . '<b>Issued by</b>' . '</dt>
						<dd>
							' . $__templater->escape($__vars['user']['Ban']['BanUser']['username']) . '
						</dd>
					...
					<dl class="pairs pairs--columns pairs--fixedSmall">
						<dt>' . '<b>Ban date</b>' . '</dt>
						<dd>
							' . $__templater->func('date_dynamic', array($__vars['user']['Ban']['ban_date'], array(
		))) . '
						</dd>
					...
					<dl class="pairs pairs--columns pairs--fixedSmall">
						...
						<dd>
							';
		if ($__vars['user']['Ban']['end_date']) {
			$__finalCompiled .= '
								' . $__templater->func('date_dynamic', array($__vars['user']['Ban']['end_date'], array(
			))) . '
								';
		} else {
			$__finalCompiled .= '
		...
		$__finalCompiled .= '
					...
					<dl class="pairs pairs--columns pairs--fixedSmall">
						<dt>' . '<b>Reason</b>' . '</dt>
						<dd>
							' . $__templater->escape($__vars['user']['Ban']['user_reason']) . '
						</dd>
					</dl>
				</div>
			</div>
