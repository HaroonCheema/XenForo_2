...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('trakt_tv_edit_show');
	$__finalCompiled .= '
...
';
	$__compilerTemp1 = '';
	if ($__templater->method($__vars['xf']['visitor'], 'hasPermission', array('forum', 'trakt_edit_shows', ))) {
		$__compilerTemp1 .= '
			...
			'label' => 'Trailer',
			'explain' => 'trakt_tv_trailer_explain',
		)) . '
			';
	} else {
		$__compilerTemp1 .= '
