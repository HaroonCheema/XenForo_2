...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if (($__vars['content']['Thread']['node_id'] == $__vars['xf']['options']['fs_escrow_applicable_forum']) AND ($__vars['content']['Thread']['escrow_id'] != 0)) {
		$__finalCompiled .= '
	' . '' . $__templater->func('username_link', array($__vars['user'], false, array('defaultname' => $__vars['alert']['username'], ), ), true) . ' mentioned you in an escrow ' . (((('<a href="' . $__templater->func('link', array('threads', $__vars['content']['Thread'], ), true)) . '" class="fauxBlockLink-blockLink">') . $__templater->escape($__vars['content']['Thread']['title'])) . '</a>') . '.' . '
	';
	} else {
		$__finalCompiled .= '
