<?php
// FROM HASH: 0b06d8a522595375c1b06e5c8a1e2022
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
			<a href="' . $__templater->func('link', array('meetings', $__vars['category'], ), true) . '" class="categoryList-link' . ($__vars['isSelected'] ? ' is-selected' : '') . '">
				' . $__templater->escape($__vars['category']['title']) . '
			</a>
			<span class="categoryList-label">
				<span class="label label--subtle label--smallest">' . $__templater->escape($__vars['category']['meeting_count']) . '</span>
			</span>
		</div>
		';
	if ($__vars['children']) {
