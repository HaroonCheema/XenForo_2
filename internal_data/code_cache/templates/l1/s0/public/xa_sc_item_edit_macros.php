<?php
// FROM HASH: 4773c32123884f7d3839055eb12c1793
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . $__templater->formTextAreaRow(array(
		...
		'label' => 'Description',
		'explain' => 'Optional:  Provide a very brief description of your spa',
	)) . '
';
	return $__finalCompiled;
}
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . $__templater->formTextBoxRow(array(
		...
		'label' => 'Location',
		'explain' => 'Enter the address of the location associated with your item if you wish to link to a google map. <br>
