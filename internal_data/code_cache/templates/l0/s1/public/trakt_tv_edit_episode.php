<?php
// FROM HASH: 55b130854dc27f73e78ef7d4649d2139
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('trakt_tv_edit_episode');
	$__finalCompiled .= '
...
';
	$__compilerTemp1 = '';
	if ($__templater->method($__vars['xf']['visitor'], 'hasPermission', array('forum', 'trakt_edit_episodes', ))) {
		$__compilerTemp1 .= '
...
', array(
		'action' => $__templater->func('link', array('tvTrakt/episode/edit', $__vars['post'], ), false),
		'ajax' => 'true',
		'class' => 'block',
