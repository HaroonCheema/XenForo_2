<?php
// FROM HASH: 4c892a5923d90ee2c916e48f8b805582
return array(
'macros' => array('articles_block' => array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
	if ($__templater->func('property', array('EWRporta_infinite', ), false) AND (($__vars['page'] == 1) AND ($__vars['total'] > $__vars['perPage']))) {
		$__finalCompiled .= '
		';
	...
	';
	if ($__templater->func('property', array('EWRporta_masonry', ), false)) {
		$__finalCompiled .= '
		';
	...
	<div class="block ' . ($__vars['infnt'] ? 'porta-infinite' : '') . ' ' . ($__vars['msnry'] ? 'porta-masonry' : '') . '"
			...
			data-masonry="' . $__templater->escape($__vars['msnry']) . '"
		 	data-click="' . $__templater->func('property', array('EWRporta_infinite_click', ), true) . '"
		 	data-after="' . $__templater->func('property', array('EWRporta_infinite_after', ), true) . '"
		 	data-history="' . $__templater->func('property', array('EWRporta_infinite_history', ), true) . '">
		';
	$__vars['i'] = 0;
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if (strlen(trim($__compilerTemp1)) > 0) {
		$__finalCompiled .= '
				<a class="porta-article-header" data-cache="false"
					data-xf-click="' . (((!$__templater->func('property', array('EWRporta_header_linked', ), false)) AND ($__vars['article']['article_icon']['type'] == 'medio')) ? 'overlay' : '') . '"
					href="' . (((!$__templater->func('property', array('EWRporta_header_linked', ), false)) AND $__vars['article']['article_icon']['link']) ? $__templater->escape($__vars['article']['article_icon']['link']) : $__templater->func('link', array('threads', $__vars['article']['Thread'], ), true)) . '">
		...
		if ($__vars['article']['Thread']['prefix_id']) {
			$__finalCompiled .= $__templater->func('prefix', array('thread', $__vars['article']['Thread'], 'html', '', ), true);
		}
		$__finalCompiled .= '
		...
		$__finalCompiled .= '
				<h2 class="block-header">
					<a href="' . $__templater->func('link', array('threads', $__vars['article']['Thread'], ), true) . '">
						';
		if ($__vars['article']['Thread']['prefix_id']) {
			$__finalCompiled .= $__templater->func('prefix', array('thread', $__vars['article']['Thread'], 'html', '', ), true);
		}
	...
	$__finalCompiled .= '
			...
			<div class="block-body message-inner">
				';
	if ($__templater->func('property', array('EWRporta_dateblock', ), false)) {
		$__finalCompiled .= '
					<div class="message-cell porta-article-date">
						<div class="porta-date-block">
							';
		if ($__vars['article']['article_sticky']) {
			$__finalCompiled .= '
								<b>' . $__templater->fontAwesome('fa-thumbtack', array(
			)) . '</b>
								' . 'PIN' . '
							';
		} else {
			$__finalCompiled .= '
								' . $__templater->func('time', array($__vars['article']['article_date'], 'M', ), true) . '
								<b>' . $__templater->func('time', array($__vars['article']['article_date'], 'd', ), true) . '</b>
							';
		}
		$__finalCompiled .= '
						</div>
						...
						<div class="message-attribution-main">
							<ul class="listInline listInline--bullet">
								<li>
									...
									<a href="' . $__templater->func('link', array('ewr-porta/authors', $__vars['article']['Thread']['User'], ), true) . '" class="u-concealed">
								...
								<li>
									...
									<a href="' . $__templater->func('link', array('threads', $__vars['article']['Thread'], ), true) . '" class="u-concealed">
	...
	$__finalCompiled .= '
						...
						' . $__templater->func('bb_code', array($__vars['article']['article_excerpt'], 'ewr_porta_article', $__vars['article']['Thread']['FirstPost'], ), true) . '

						';
	if ($__vars['article']['article_break']) {
		$__finalCompiled .= '
							<a href="' . $__templater->func('link', array('threads', $__vars['article']['Thread'], ), true) . '">' . $__templater->escape($__vars['article']['article_break']) . '</a>.
						';
	}
	$__finalCompiled .= '
					</div>
	...
	if ($__templater->isTraversable($__vars['catlinks'])) {
		foreach ($__vars['catlinks'] AS $__vars['catlink']) {
			$__finalCompiled .= '
						...
						', array(
				'href' => $__templater->func('link', array('ewr-porta/categories', $__vars['catlink']['Category'], ), false),
			), '', array(
			)) . '		
					';
		}
	...
	$__finalCompiled .= '
				...
				<div class="block-footer-controls">
					...
					', array(
		'href' => $__templater->func('link', array('threads', $__vars['article']['Thread'], ), false),
		'fa' => 'fa-sign-in',
	), '', array(
	)) . '
				</div>
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
	';
	if ($__templater->func('property', array('EWRporta_header', ), false)) {
		$__finalCompiled .= '
		';
		if (($__vars['article']['article_icon']['type'] == 'medio') AND $__vars['article']['article_icon']['data']) {
			$__finalCompiled .= '
			<div class="porta-header-medio"
				style="background-image: url(\'' . $__templater->func('base_url', array($__vars['article']['article_icon']['data']['image'], ), true) . '\');">
			</div>
			<div class="porta-header-play">' . $__templater->fontAwesome('fab fa-youtube', array(
			)) . '</div>
		';
			...
			<div class="porta-header-image"
				style="background-image: url(\'' . $__templater->func('link', array('full:ewr-porta/attachments', $__vars['attachments'][$__vars['article']['article_icon']['data']], ), true) . '\');">
			</div>
		';
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
	';
	if ((!$__templater->func('property', array('EWRporta_header', ), false)) AND (($__vars['article']['article_icon']['type'] == 'attach') AND $__vars['attachments'][$__vars['article']['article_icon']['data']])) {
		$__finalCompiled .= '
		<a href="' . $__templater->func('link', array('threads', $__vars['article']['Thread'], ), true) . '">
			<img border="0"
	...
	';
	} else if ((!$__templater->func('property', array('EWRporta_header', ), false)) AND (($__vars['article']['article_icon']['type'] == 'image') AND $__vars['xf']['options']['EWRporta_icon_external'])) {
		$__finalCompiled .= '
		<a href="' . $__templater->func('link', array('threads', $__vars['article']['Thread'], ), true) . '">
			<img border="0"
	...
	';
		...
		$__finalCompiled .= '
		' . $__templater->func('avatar', array($__vars['article']['Thread']['User'], 's', false, array(
