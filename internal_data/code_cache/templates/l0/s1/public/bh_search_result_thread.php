<?php
// FROM HASH: 67140aaf4c3e36be6613627b087d6653
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="contentRow ' . ((!$__templater->method($__vars['thread'], 'isVisible', array())) ? 'is-deleted' : '') . '">
		...
		<div class="contentRow-main">
			...
			';
	if ($__vars['xf']['options']['bh_displayExcerpt']) {
		$__finalCompiled .= '
				<div class="contentRow-snippet">' . $__templater->func('snippet', array($__vars['thread']['FirstPost']['message'], $__vars['xf']['options']['bh_excerptLength'], array('term' => $__vars['options']['term'], 'stripQuote' => true, ), ), true) . '</div>
			';
	}
	$__finalCompiled .= '
