<?php
// FROM HASH: 7d4f9ad1a461ec7ff593b859abd0fc0e
return array(
...
'main_cell' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
				...
				' . $__templater->func('prefix', array('thread', $__vars['post'], 'html', '', ), true) . '
				<a href="' . $__templater->func('link', array('posts', $__vars['post'], ), true) . '" class="" data-tp-primary="on">' . $__templater->escape($__vars['thread']['title']) . '</a>
				' . $__templater->func('snippet', array($__vars['post']['message'], 25, array('stripQuote' => true, ), ), true) . '
