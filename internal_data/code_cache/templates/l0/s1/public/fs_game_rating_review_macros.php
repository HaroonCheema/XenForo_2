<?php
// FROM HASH: ec1642c920651dfb4482f5a55a9e8a08
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="message message--simple">
		<span class="u-anchorTarget" id="resource-review-' . $__templater->escape($__vars['review']['review_id']) . '"></span>
	...
	$__finalCompiled .= '
		...
		'class' => 'ratingStars--smaller',
					...
					<span class="" style="font-size: 1.17em; font-weight: bold;">
						' . $__templater->escape($__vars['review']['Game']['title']) . '
					</span>
	...
	if (($__vars['xf']['visitor']['is_admin'] OR ($__vars['xf']['visitor']['user_id'] == $__vars['review']['user_id']))) {
		...
		$__compilerTemp2 .= '
											...
											<a href="' . $__templater->func('link', array('game-rating/delete', $__vars['review'], ), true) . '"
