<?php
// FROM HASH: 7b480dd043751f88b29157487edf4b60
return array(
...
';
	if ($__vars['ad']['settings']['daily_stats']) {
		$__finalCompiled .= '
	' . $__templater->callMacro('siropu_ads_manager_ad_stats_macros', 'totals', array(
			'ad' => $__vars['ad'],
		), $__vars) . '

	' . $__templater->callMacro('siropu_ads_manager_ad_stats_macros', 'filter', array(
			'link' => ($__vars['accessKey'] ? $__templater->func('link', array('ads-manager/statistics/daily', array('access_key' => $__vars['accessKey'], ), array('ad_id' => $__vars['ad']['ad_id'], ), ), false) : $__templater->func('link', array('ads-manager/ads/daily-stats', $__vars['ad'], ), false)),
	...
	<div class="block">
		...
		' . $__templater->func('page_nav', array(array(
			'page' => $__vars['page'],
			'total' => $__vars['total'],
			'link' => ($__vars['accessKey'] ? 'ads-manager/statistics/daily' : 'ads-manager/ads/daily-stats'),
