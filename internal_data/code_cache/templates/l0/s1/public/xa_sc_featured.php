...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['category']) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Featured spa' . ' - ' . ($__vars['category']['meta_title'] ? $__templater->escape($__vars['category']['meta_title']) : $__templater->escape($__vars['category']['title'])));
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageH1'] = $__templater->preEscaped('Featured spa');
		$__finalCompiled .= '
	';
...
';
		...
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Featured spa');
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
