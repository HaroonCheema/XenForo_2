<?php
// FROM HASH: f60b79e798edbdb6f30784e6ca868804
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if (!$__templater->test($__vars['filmStripParams']['Items'], 'empty', array())) {
			...
			<div class="block-outer-middle">
				<div class="itemList itemList--strip js-filmStrip">
					...
					<a data-xf-click="inserter" data-replace=".js-filmStrip"
						href="' . $__templater->func('link', array('bh-item/filmstripjump', $__vars['item'], array('direction' => 'prev', 'attachment_id' => $__vars['filmStripParams']['firstItem']['attachment_id'], ), ), true) . '"
			...
			foreach ($__vars['filmStripParams']['Items'] AS $__vars['attachItem']) {
				$__finalCompiled .= '
						<div class="js-filmStrip-item itemList-item">
							<a href="' . $__templater->func('link', array($__vars['xf']['options']['bh_main_route'] . '/item', $__vars['item'], array('attachment_id' => $__vars['attachItem']['attachment_id'], ), ), true) . '">
		...
		$__finalCompiled .= '
					...
					<a data-xf-click="inserter" data-replace=".js-filmStrip"
						href="' . $__templater->func('link', array('bh-item/filmstripjump', $__vars['item'], array('direction' => 'next', 'attachment_id' => $__vars['filmStripParams']['lastItem']['attachment_id'], ), ), true) . '"
