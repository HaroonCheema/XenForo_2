<?php
// FROM HASH: b20790b460ff7e8bbe00a4f13ee74600
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__compilerTemp1 .= '
			';
	if ($__vars['selectedNavEntry'] AND ($__vars['selectedNavEntry']['href'] AND (($__vars['selectedNavEntry']['href'] != $__vars['xf']['uri']) AND (($__vars['selectedNavEntry']['href'] != $__vars['rootBreadcrumb']['href']) AND ($__vars['selectedNavEntry']['href'] != '/forums/db/'))))) {
		$__compilerTemp1 .= '
				';
		$__vars['position'] = ($__vars['position'] + 1);
		$__compilerTemp1 .= '
...
<head>
	...
	$__finalCompiled .= '
	<title>' . $__templater->func('page_title', array('%s - TractorByNet', $__vars['xf']['options']['boardTitle'], $__vars['pageNumber'])) . '</title>
	';
    ...
    <xen:if is="' . $__templater->escape($__vars['auctionType']) . '">
        <meta name="auction-type" content="' . $__templater->escape($__vars['auctionType']) . '" />
    </xen:if>
 
	' . $__templater->includeTemplate('riv_scripts', $__vars) . '
	';
	if ($__vars['xf']['visitor']['user_id']) {
		$__finalCompiled .= '<meta name="user" status="true">';
	}
	$__finalCompiled .= '
	</head>
...
';
	...
	if ($__vars['xf']['visitor']['is_moderator'] AND ((!$__vars['xf']['options']['reportIntoForumId']) AND $__vars['xf']['session']['reportCounts']['total'])) {
		$__compilerTemp1 .= '
					<a href="' . $__templater->func('link', array('reports', ), true) . '"
						...
						title="' . ($__vars['xf']['session']['reportCounts']['lastBuilt'] ? (('Last report update' . $__vars['xf']['language']['label_separator'] . ' ') . $__templater->func('date_time', array($__vars['xf']['session']['reportCounts']['lastBuilt'], ), true)) : '') . '">
						' . 'Reports' . '
					</a>
				';
	}
	...
	if ($__vars['xf']['visitor']['is_moderator'] AND (!$__vars['xf']['options']['reportIntoForumId'])) {
		$__compilerTemp2 .= '
								<a href="' . $__templater->func('link', array('reports', ), true) . '" class="menu-linkRow" title="' . ($__vars['xf']['session']['reportCounts']['lastBuilt'] ? (('Last report update' . $__vars['xf']['language']['label_separator'] . ' ') . $__templater->func('date_time', array($__vars['xf']['session']['reportCounts']['lastBuilt'], ), true)) : '') . '">' . 'Reports' . '</a>
							';
	}
	$__compilerTemp2 .= '
							' . '
			...
			<div class="p-nav-smallLogo">
				<a href="' . (($__vars['xf']['options']['logoLink'] AND $__vars['xf']['homePageUrl']) ? $__templater->escape($__vars['xf']['homePageUrl']) : $__templater->func('link', array('index', ), true)) . '">
					<img src="https://www.tractorbynet.com/forums/styles/tractor/logo-text-only.png"
						alt="' . $__templater->escape($__vars['xf']['options']['boardTitle']) . '"
					' . ($__templater->func('property', array('/styles/tractor/logo-text-only.png', ), false) ? 'srcset="/styles/tractor/logo-text-only.png 2x"' : '') . ' />
				</a>
			</div>
...
' . $__templater->includeTemplate('riv_footer', $__vars) . '
<footer class="p-footer" id="footer">
	...
	$__compilerTemp11 = '';
	$__compilerTemp11 .= '
							<div class="bottomsidebar p-sectionLinks bottomalt">' . $__templater->renderWidget('footerblock2', array(), array()) . '</div>
							';
