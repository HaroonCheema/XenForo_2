<?php
// FROM HASH: 96459106321ed29e62ff3dcce71ac707
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
		$__templater->includeJs(array(
			'dev' => 'nick97/TraktTV/slider.js',
			'prod' => 'nick97/TraktTV/slider.min.js',
			'addon' => 'nick97/TraktTV',
		));
		$__finalCompiled .= '

	<div class="carousel carousel--withFooter" ' . $__templater->func('widget_data', array($__vars['widget'], ), true) . '>
		<ul class="carousel-body carousel-body--show2" data-xf-init="trakt-tv-slider"
			data-xf-trakt-tv-slider="' . $__templater->filter($__vars['options']['slider'], array(array('json', array()),), true) . '">
			';
