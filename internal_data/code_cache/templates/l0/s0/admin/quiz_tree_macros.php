<?php
// FROM HASH: a1ef69695ea7f5558facd6261eb319e9
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
		<div class="buttonGroup">
			' . $__templater->button('Add Quiz', array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
	if ($__templater->method($__vars['quizTree'], 'count', array()) > 0) {
		$__finalCompiled .= '
		<div class="block">
			...
			<div class="block-container">
				<div class="block-body">
					';
		$__compilerTemp1 = '';
		if ($__templater->isTraversable($__vars['quizTree'])) {
			foreach ($__vars['quizTree'] AS $__vars['treeEntry']) {
				$__compilerTemp1 .= '
							';
				$__vars['quiz'] = $__vars['treeEntry'];
				$__compilerTemp1 .= '
							';
				$__compilerTemp2 = array(array(
					...
					'_type' => 'cell',
					'html' => '
									<a href="' . $__templater->func('link', array('quiz/addEdit', $__vars['quiz'], ), true) . '">
										<div class="u-depth' . $__templater->escape($__vars['quiz']) . '">
											<div class="dataList-mainRow">' . $__templater->escape($__vars['treeEntry']['quiz_name']) . '</div>
										</div>
									</a>
								',
				));
				if ($__vars['quiz'] == null) {
					$__compilerTemp2[] = array(
						'class' => ($__vars['quiz']['question_type'] ? 'dataList-cell--highlighted' : ''),
				...
				$__compilerTemp2[] = array(
					'href' => $__templater->func('link', array($__vars['linkPrefix'] . '/confirm', $__vars['quiz'], ), false),
					'_type' => 'delete',
					'html' => '',
				);
