<?php
// FROM HASH: 464fcd00e268aba999c0aa29b2d32aa5
return array(
...
<h3 class="block-formSectionHeader">
	<span class="collapseTrigger collapseTrigger--block" data-xf-click="toggle" data-target="< :up:next">
		<span class="block-formSectionHeader-aligner">' . 'trakt_tv_slider_options' . '</span>
	</span>
</h3>
...
<div class="block-body block-body--collapsible is-active">
	...
	' . $__templater->formRow('
		...
		'min' => '1',
			...
			<span class="inputGroup-text">' . 'trakt_tv_breakpoint:' . '</span>
			' . $__templater->formNumberBox(array(
	...
	', array(
		'rowtype' => 'input',
		'label' => 'trakt_tv_slider_items_items_wide',
	)) . '
	...
	', array(
		'rowtype' => 'input',
		'label' => 'trakt_tv_slider_items_items_medium',
	)) . '
