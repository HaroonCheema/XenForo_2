<?php
// FROM HASH: 0c14604266afa8276b1398a0fc4c9f3d
return array(
	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('
				...
				<strong><a href="' . $__templater->func('link', array('navigation/edit-forums', $__vars['navigation'], ), true) . '">' . $__templater->escape($__vars['navigation']['title']) . '</a></strong>
			', array(
		'rowtype' => 'confirm',
	)) . '
...
', array(
		'action' => $__templater->func('link', array('navigation/delete-nav', $__vars['navigation'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	));
