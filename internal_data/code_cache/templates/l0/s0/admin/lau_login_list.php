...
';
    ...
    ';
		...
		if ($__templater->isTraversable($__vars['laulogs'])) {
			foreach ($__vars['laulogs'] AS $__vars['laulog']) {
				...
				array(
					'_type' => 'cell',
					'html' => $__templater->func('username_link', array($__vars['laulog']['FromUser'], false, array(
					'href' => $__templater->func('link', array('users/edit', $__vars['laulog']['FromUser'], ), false),
				))),
				),
				array(
					'_type' => 'cell',
					'html' => $__templater->func('username_link', array($__vars['laulog']['ToUser'], false, array(
					'href' => $__templater->func('link', array('users/edit', $__vars['laulog']['ToUser'], ), false),
				))),
				),
				array(
					'_type' => 'cell',
					'html' => $__templater->func('date_dynamic', array($__vars['laulog']['dateline'], array(
				))),
				),
				array(
					'class' => 'u-ltr',
				...
				array(
					'href' => $__templater->func('link', array('laulogs/delete', $__vars['laulog'], ), false),
					'_type' => 'delete',
					'html' => '',
				))) . '
                    ';
		...
		array(
            ...
            <div class="block-footer block-footer--split">
                <span class="block-footer-counter">' . $__templater->func('display_totals', array($__vars['laulogs'], $__vars['total'], ), true) . '</span>
    ...
    ', array(
			'action' => $__templater->func('link', array('laulogs/mass-delete', ), false),
			'ajax' => 'true',
			'class' => 'block',
		)) . '
    ';
