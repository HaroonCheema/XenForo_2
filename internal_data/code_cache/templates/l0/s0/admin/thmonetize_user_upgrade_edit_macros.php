<?php
// FROM HASH: dc4b6b3c044dca48908dbb40f6baeee7
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . $__templater->formTextBoxRow(array(
		'name' => 'thmonetize_redirect_url',
		'value' => $__vars['upgrade']['thmonetize_redirect_url'],
		'type' => 'url',
	), array(
		'label' => 'Redirect URL',
	)) . '
	...
	if ($__templater->isTraversable($__vars['upgrade']['thmonetize_features'])) {
		foreach ($__vars['upgrade']['thmonetize_features'] AS $__vars['feature']) {
			$__compilerTemp1 .= '
				...
				'name' => 'thmonetize_features[text][]',
				'value' => $__vars['feature']['text'],
				'placeholder' => 'Text',
			)) . '
						' . $__templater->formTextBox(array(
				'name' => 'thmonetize_features[description][]',
				'value' => $__vars['feature']['description'],
