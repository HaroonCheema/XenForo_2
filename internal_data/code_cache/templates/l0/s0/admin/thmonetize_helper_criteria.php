<?php
// FROM HASH: 211a9c3cb28513a0b97ce56f49d3e068
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__vars['panes'] = $__templater->preEscaped('
		<li class="' . (($__vars['active'] == 'user_upgrade') ? ' is-active' : '') . '" role="tabpanel"
			id="' . $__templater->func('unique_id', array('criteriaUserUpgrade', ), true) . '">
			' . $__templater->formCheckBoxRow(array(
	), array(array(
