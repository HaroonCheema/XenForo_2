<?php
// FROM HASH: 048358d2e88801aa0e686c5df0046363
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->isTraversable($__vars['data'])) {
		...
		' . $__templater->dataRow(array(
			...
			array(
				'href' => $__templater->func('link', array('team/edit', $__vars['value'], ), false),
				'_type' => 'action',
				'html' => 'Edit',
			),
			array(
				'href' => $__templater->func('link', array('team/delete', $__vars['value'], ), false),
				'overlay' => 'true',
				'_type' => 'delete',
				'html' => '',
			))) . '
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('[FS] Create Team');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
	' . $__templater->button('Add Team', array(
		'href' => $__templater->func('link', array('team/add', ), false),
		'icon' => 'add',
	), '', array(
	)) . '
');
