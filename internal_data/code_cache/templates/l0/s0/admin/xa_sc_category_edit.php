<?php
// FROM HASH: 6f28116b10385f08f59840b85b9c26cd
return array(
...
<b>Note:</b> If you want the entire category tree for this specific category to be exapanded, you will need to edit each sub category in the trees and set this option. ',
		...
		'label' => 'Default tags',
		'explain' => '
					' . 'This allows you to preset one or more tags on the add spa form for item created within this category.  <b>Note</b>:  These tags are not force added, the member creating the item can remove then prior to creating the new item. ' . '
					<br><br>
