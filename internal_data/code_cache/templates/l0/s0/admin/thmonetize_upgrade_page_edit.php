<?php
// FROM HASH: 064e6eb5bafcc7f436458670c7008345
return array(
...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->func('link', array('thmonetize-upgrade-pages/delete', $__vars['upgradePage'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
', array(
		'action' => $__templater->func('link', array('thmonetize-upgrade-pages/save', $__vars['upgradePage'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
