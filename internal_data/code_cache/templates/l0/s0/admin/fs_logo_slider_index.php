<?php
// FROM HASH: e343f898d80b0f76c6cbae13ae1afe43
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->isTraversable($__vars['data'])) {
		...
		' . $__templater->dataRow(array(
				...
				'_type' => 'cell',
				'html' => ' ' . $__templater->escape($__vars['value']['logo_url']) . ' ',
			),
			array(
				'href' => $__templater->func('link', array('logo-slider/edit', $__vars['value'], ), false),
				'_type' => 'action',
				'html' => 'Edit',
			),
			array(
				'href' => $__templater->func('link', array('logo-slider/delete', $__vars['value'], ), false),
				'overlay' => 'true',
				'_type' => 'delete',
				'html' => '',
			))) . '
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('[FS] Logo Slider');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
	' . $__templater->button('Add logo', array(
		'href' => $__templater->func('link', array('logo-slider/add', ), false),
		'icon' => 'add',
	), '', array(
	)) . '
');
