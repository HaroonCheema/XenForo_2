<?php
// FROM HASH: 9fcae3fcb96a15aa85dd133d8af9ec5d
return array(
...
';
	...
	' . $__templater->button('Add sponsor', array(
		'href' => $__templater->func('link', array('thmonetize-sponsors/add', ), false),
		'icon' => 'add',
	), '', array(
	)) . '
');
...
';
		...
		if ($__templater->isTraversable($__vars['sponsors'])) {
			foreach ($__vars['sponsors'] AS $__vars['sponsor']) {
				$__compilerTemp1 .= '
					...
					'href' => $__templater->func('link', array('thmonetize-sponsors/edit', $__vars['sponsor'], ), false),
					'delete' => $__templater->func('link', array('thmonetize-sponsors/delete', $__vars['sponsor'], ), false),
				), array(array(
	...
	', array(
			'action' => $__templater->func('link', array('thmonetize-sponsors/toggle', ), false),
			'class' => 'block',
			'ajax' => 'true',
		)) . '
';
