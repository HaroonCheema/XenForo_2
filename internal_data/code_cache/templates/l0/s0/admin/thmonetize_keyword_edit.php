<?php
// FROM HASH: 53bc8b3fbec3a952c32f116f322d8c7a
return array(
...
';
	...
	' . $__templater->button('', array(
			'href' => $__templater->func('link', array('thmonetize-keywords/delete', $__vars['keyword'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
', array(
		'action' => $__templater->func('link', array('thmonetize-keywords/save', $__vars['keyword'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
