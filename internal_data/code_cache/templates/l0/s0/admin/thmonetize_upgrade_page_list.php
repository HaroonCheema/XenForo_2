<?php
// FROM HASH: 15a535df70ef590bfa1a8c9e2b4ff2c8
return array(
...
';
	...
	' . $__templater->button('Add upgrade page', array(
		'href' => $__templater->func('link', array('thmonetize-upgrade-pages/add', ), false),
		'icon' => 'add',
	), '', array(
	)) . '
');
...
';
		...
		if ($__templater->isTraversable($__vars['upgradePages'])) {
			foreach ($__vars['upgradePages'] AS $__vars['upgradePage']) {
				$__compilerTemp1 .= '
					...
					'href' => $__templater->func('link', array('thmonetize-upgrade-pages/edit', $__vars['upgradePage'], ), false),
					'delete' => $__templater->func('link', array('thmonetize-upgrade-pages/delete', $__vars['upgradePage'], ), false),
				), array(array(
	...
	', array(
			'action' => $__templater->func('link', array('thmonetize-upgrade-pages/toggle', ), false),
			'class' => 'block',
			'ajax' => 'true',
		)) . '
';
