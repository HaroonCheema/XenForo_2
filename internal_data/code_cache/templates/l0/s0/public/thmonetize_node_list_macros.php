<?php
// FROM HASH: 16571d44209a14d9e1b29330a14243d6
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['node']['Sponsor']['active'] AND $__vars['node']['Sponsor']['image']) {
		...
		<div class="node-thMonetizeSponsorImage" style="width: ' . $__templater->escape($__vars['node']['Sponsor']['width']) . 'px;">
			<a target="_blank" href="' . $__templater->escape($__vars['node']['Sponsor']['url']) . '"><img src="' . $__templater->escape($__vars['node']['Sponsor']['image']) . '" width="' . $__templater->escape($__vars['node']['Sponsor']['width']) . '" height="' . $__templater->escape($__vars['node']['Sponsor']['height']) . '"></a>
		</div>
	';
	}
	$__finalCompiled .= '
