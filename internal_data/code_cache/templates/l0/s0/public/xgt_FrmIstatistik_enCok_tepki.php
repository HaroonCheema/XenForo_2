<?php
// FROM HASH: 09ffe7558e0774a872d8d46a30d6c1e5
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__finalCompiled .= $__templater->callMacro('xgt_FrmIstatistik_miniHeader_macros', 'encoktepki', array(
		'encoktepki' => '!',
	), $__vars) . '
 ';
		...
		if ($__templater->isTraversable($__vars['threads'])) {
			...
			<li class="_xgtIstatistik-satir">
				...
				if ($__templater->func('property', array('xgt_Frmistatistik_mesaj_sayisi', ), false)) {
					...
					<div class="_xgtIstatistik-satir--hucre _xgtIstatistik-satir--goruntuleme" data-xf-init="tooltip" title="' . 'Tepki' . '">
						<div class="TepkiVurgusu">
