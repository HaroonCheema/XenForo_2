<?php
// FROM HASH: 917f0bff26d12c30ad1cc1d4c999aaa6
return array(
...
';
	...
	if ($__templater->method($__vars['thread'], 'canDelete', array())) {
		$__compilerTemp5 .= '
			...
			'href' => $__templater->func('link', array('threads/delete-ad', $__vars['thread'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
	...
	' . $__compilerTemp7 . '
', array(
		'action' => $__templater->func('link', array('threads/edit-ad', $__vars['thread'], ), false),
		'class' => 'block',
