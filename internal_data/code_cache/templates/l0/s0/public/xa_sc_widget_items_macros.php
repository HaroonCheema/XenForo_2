<?php
// FROM HASH: 98428486a79a79fd548cd6bdb69946c6
return array(
				...
				if ($__vars['i'] == 1) {
					...
					if ($__vars['itemsCount'] < 3) {
						...
						$__finalCompiled .= '
										...
										';
						if ($__vars['item']['Category']['allow_location'] AND ($__vars['item']['Category']['display_location_on_list'] AND $__vars['item']['location_data'])) {
							$__finalCompiled .= '
											<div class="item-location">
												';
							if ($__vars['item']['Category']['location_on_list_display_type'] == 'city_state') {
								$__finalCompiled .= '
													' . $__templater->escape($__vars['item']['location_data']['city']) . ', ' . $__templater->escape($__vars['item']['location_data']['state']) . '
												';
							} else if ($__vars['item']['Category']['location_on_list_display_type'] == 'city_state_short') {
								$__finalCompiled .= '
													' . $__templater->escape($__vars['item']['location_data']['city']) . ', ' . $__templater->escape($__vars['item']['location_data']['state_short']) . '
												';
							} else if ($__vars['item']['Category']['location_on_list_display_type'] == 'city_state_country') {
								$__finalCompiled .= '
													' . $__templater->escape($__vars['item']['location_data']['city']) . ', ' . $__templater->escape($__vars['item']['location_data']['state']) . ', ' . $__templater->escape($__vars['item']['location_data']['country']) . '
												';
							} else if ($__vars['item']['Category']['location_on_list_display_type'] == 'city_state_country_short') {
								$__finalCompiled .= '
													' . $__templater->escape($__vars['item']['location_data']['city']) . ', ' . $__templater->escape($__vars['item']['location_data']['state']) . ', ' . $__templater->escape($__vars['item']['location_data']['country_short']) . '
												';
							} else if ($__vars['item']['Category']['location_on_list_display_type'] == 'city_state_short_country_short') {
								$__finalCompiled .= '
													' . $__templater->escape($__vars['item']['location_data']['city']) . ', ' . $__templater->escape($__vars['item']['location_data']['state_short']) . ', ' . $__templater->escape($__vars['item']['location_data']['country_short']) . '
												';
							} else if ($__vars['item']['Category']['location_on_list_display_type'] == 'formatted_address') {
								$__finalCompiled .= '
													' . $__templater->escape($__vars['item']['location_data']['formatted_address']) . '
												';
							} else {
								$__finalCompiled .= '
													' . $__templater->escape($__vars['item']['location_data']['city']) . ', ' . $__templater->escape($__vars['item']['location_data']['state']) . '
							...
							if ($__templater->method($__vars['item'], 'canViewItemMap', array())) {
								$__finalCompiled .= '
													<a href="' . $__templater->func('link', array('showcase/map-overlay', $__vars['item'], ), true) . '" rel="nofollow" class="item-location-icon" data-xf-click="overlay">' . $__templater->fontAwesome('fa-map-marker-alt', array(
								)) . '</a>
												';
							}
							$__finalCompiled .= '
						...
						if ($__vars['extras']['category_title']) {
							$__compilerTemp1 .= '
													<li><a class="category-title category-' . $__templater->escape($__vars['item']['category_id']) . '" href="' . $__templater->func('link', array('showcase', $__vars['item'], ), true) . '">' . $__templater->escape($__vars['item']['Category']['title']) . '</a></li>
												';
						}
						$__compilerTemp1 .= '
											';
	...
	if (!$__templater->test($__vars['items'], 'empty', array())) {
		...
		if ($__templater->isTraversable($__vars['items'])) {
			foreach ($__vars['items'] AS $__vars['item']) {
				...
				if ($__vars['item']['Category']['allow_location'] AND ($__vars['item']['Category']['display_location_on_list'] AND $__vars['item']['location_data'])) {
					$__finalCompiled .= '
										<div class="contentRow-minor contentRow-minor--smaller contentRow-itemLocation">
											';
					if ($__vars['item']['Category']['location_on_list_display_type'] == 'city_state') {
						$__finalCompiled .= '
												' . $__templater->escape($__vars['item']['location_data']['city']) . ', ' . $__templater->escape($__vars['item']['location_data']['state']) . '
					...
					$__finalCompiled .= '
											<a href="' . $__templater->func('link', array('showcase/map-overlay', $__vars['item'], ), true) . '" rel="nofollow" class="contentRow-itemLocationIcon" data-xf-click="overlay">' . $__templater->fontAwesome('fa-map-marker-alt', array(
					)) . '</a>
										</div>	
									';
				}
				...
				if ($__vars['extras']['custom_fields']) {
					$__finalCompiled .= '
										';
					$__vars['scCustomFieldGroupNames'] = array('header', 'section_1', 'section_2', 'section_3', 'section_4', 'section_5', 'new_tab', 'sidebar', 'new_sidebar_block', 'self_place', );
					$__finalCompiled .= '
										';
					$__compilerTemp1 = '';
					$__compilerTemp1 .= '
		...
		if ($__templater->isTraversable($__vars['items'])) {
			foreach ($__vars['items'] AS $__vars['item']) {
				...
				if ($__vars['extras']['cover_image']) {
					$__finalCompiled .= '
										';
					if ($__vars['item']['cover_image_id'] AND $__templater->method($__vars['xf']['visitor'], 'hasShowcaseItemPermission', array('viewItemAttach', ))) {
						$__finalCompiled .= '
											<div class="contentRow-figure">
												<a href="' . $__templater->func('link', array('showcase', $__vars['item'], ), true) . '">
