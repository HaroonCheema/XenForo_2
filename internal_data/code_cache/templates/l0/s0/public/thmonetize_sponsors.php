<?php
// FROM HASH: 9174f93573c542d558b11f91997300f8
return array(
	...
	if ($__vars['sponsor']['image']) {
		$__compilerTemp1 .= '
                        <div class="block-body">
                            <div class="block-row">
                                <a target="_blank" href="' . $__templater->escape($__vars['sponsor']['url']) . '"><img src="' . $__templater->escape($__vars['sponsor']['image']) . '" width="' . $__templater->escape($__vars['sponsor']['width']) . '" height="' . $__templater->escape($__vars['sponsor']['height']) . '"></a>
                            </div>
                        </div>
                    ';
	}
