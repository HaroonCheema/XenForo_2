<?php
// FROM HASH: 3a24993542f2545ea7022b825923b31e
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['item']['item_state'] != 'deleted') {
		...
		if ($__vars['extras']['preview_snippet']) {
			...
			if ($__vars['item']['description']) {
				$__finalCompiled .= '
							' . $__templater->func('snippet', array($__vars['item']['description'], $__vars['xf']['options']['xaScSnippetLengthIV'], array('stripQuote' => true, ), ), true) . '
						';
			} else {
				$__finalCompiled .= '
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
					...
					<span class="message-attribution-opposite sc-muted">
						';
	if ($__vars['chooseName']) {
		$__finalCompiled .= '
							<span>' . $__templater->formCheckBox(array(
			'standalone' => 'true',
		), array(array(
			'name' => $__vars['chooseName'] . '[]',
			'value' => $__vars['item']['item_id'],
	...
	$__finalCompiled .= '
				...
				';
	if ($__vars['item']['cover_image_id'] AND $__vars['extras']['cover_image']) {
		$__finalCompiled .= '
					<div class="scCoverImage">
						<div class="scCoverImage-container">
							<div class="scCoverImage-container-image js-coverImageContainerImage">
								<a href="' . $__templater->func('link', array('showcase', $__vars['item'], ), true) . '" class="" ><img src="' . $__templater->func('link', array('showcase/cover-image', $__vars['item'], ), true) . '" class="js-itemCoverImage" /></a>
							</div>
						</div>
					</div>
				';
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['item']['description']) {
		$__finalCompiled .= '
					' . $__templater->func('snippet', array($__vars['item']['description'], 75, array('stripQuote' => true, ), ), true) . '
				';
	} else {
		$__finalCompiled .= '
					' . $__templater->func('snippet', array($__vars['item']['message'], 75, array('stripQuote' => true, ), ), true) . '
				';
	}
	$__finalCompiled .= '
			</div>
