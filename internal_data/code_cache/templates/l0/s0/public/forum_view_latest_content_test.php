<?php
// FROM HASH: e00cfec2bc5708fde888cdfcb49025ae
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="structItem structItem--listing js-inlineModContainer onHoverDisp" data-author="' . ($__templater->escape($__vars['thread']['username']) ?: '') . '">
	...
	if (!$__templater->test($__vars['threads'], 'empty', array())) {
		...
		if ($__templater->isTraversable($__vars['threads'])) {
			foreach ($__vars['threads'] AS $__vars['thread']) {
				$__finalCompiled .= '
						' . $__templater->callMacro(null, 'list', $__templater->combineMacroArgumentAttributes($__vars['templateOverrides']['thread_list_macro_args'], array(
