<?php
// FROM HASH: 678e5a0d3c48795ab2a0d2801f16b280
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
	';
	if ($__vars['showTargetUser'] AND ($__vars['profilePost']['user_id'] != $__vars['profilePost']['OwnerPage']['user_id'])) {
		$__finalCompiled .= '
		...
		' . $__templater->func('username_link', array($__vars['profilePost']['OwnerPage']['User'], true, array(
			'defaultname' => 'Unknown',
			'aria-hidden' => 'true',
		))) . '
		<span class="u-srOnly">' . '' . ($__templater->escape($__vars['profilePost']['User']['username']) ?: $__templater->escape($__vars['profilePost']['username'])) . ' wrote on ' . ($__templater->escape($__vars['profilePost']['OwnerPage']['User']['username']) ?: 'Unknown') . '\'s profile.' . '</span>
	';
	} else {
		$__finalCompiled .= '
		' . $__templater->func('username_link', array($__vars['profilePost']['User'], true, array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<article class="message message--simple ' . ($__templater->method($__vars['profilePost'], 'isIgnored', array()) ? 'is-ignored' : '') . ' js-inlineModContainer"
		...
		data-content="profile-post-' . $__templater->escape($__vars['profilePost']['post_id']) . '"
		id="js-profilePost-' . $__templater->escape($__vars['profilePost']['post_id']) . '">

		<span class="u-anchorTarget" id="profile-post-' . $__templater->escape($__vars['profilePost']['post_id']) . '"></span>
		...
		'showTargetUser' => $__vars['showTargetUser'],
								...
								<li><a href="' . $__templater->func('link', array('owner-page-posts', $__vars['profilePost'], ), true) . '" class="u-concealed" rel="nofollow">' . $__templater->func('date_dynamic', array($__vars['profilePost']['post_date'], array(
	))) . '</a></li>
							</ul>
						</header>
	...
	$__finalCompiled .= '
						...
						<div class="lbContainer js-lbContainer"
							data-lb-id="profile-post-' . $__templater->escape($__vars['profilePost']['post_id']) . '"
							...
							<article class="message-body">
								' . $__templater->func('bb_code', array($__vars['profilePost']['message'], 'bh_ownerPage_post', $__vars['profilePost'], ), true) . '
							</article>
	...
	if ($__vars['profilePost']['attach_count']) {
		$__finalCompiled .= '
			...
			'canView' => $__templater->method($__vars['xf']['visitor'], 'hasPermission', array('ownerPagePost', 'viewAttachment', )),
		), $__vars) . '
							';
	}
	$__finalCompiled .= '
	...
	$__compilerTemp1 .= '
		...
		'link' => 'owner-page-posts/react',
		'list' => '< .message | .js-reactionsList',
	))) . '

									';
	if ($__templater->method($__vars['profilePost'], 'canComment', array()) AND $__templater->func('property', array('ownerPagePostCommentToggle', ), false)) {
		$__compilerTemp1 .= '
										<a class="actionBar-action actionBar-action--reply"
											data-xf-click="comment-toggle"
											data-target=".js-commentsTarget-' . $__templater->escape($__vars['profilePost']['post_id']) . '"
											data-scroll-to="true"
											role="button"
	...
	if ($__vars['allowInlineMod'] AND $__templater->method($__vars['profilePost'], 'canUseInlineModeration', array())) {
		$__compilerTemp2 .= '
			...
			'value' => $__vars['profilePost']['post_id'],
	...
	if ($__templater->method($__vars['profilePost'], 'canReport', array())) {
		$__compilerTemp2 .= '
										<a href="' . $__templater->func('link', array('owner-page-posts/report', $__vars['profilePost'], ), true) . '" class="actionBar-action actionBar-action--report" data-xf-click="overlay">' . 'Report' . '</a>
									';
	}
	$__compilerTemp2 .= '
	...
	if ($__templater->method($__vars['profilePost'], 'canEdit', array())) {
		...
		$__compilerTemp2 .= '
										<a href="' . $__templater->func('link', array('owner-page-posts/edit', $__vars['profilePost'], ), true) . '"
											class="actionBar-action actionBar-action--edit actionBar-action--menuItem"
											data-xf-click="quick-edit"
											data-editor-target="#js-profilePost-' . $__templater->escape($__vars['profilePost']['post_id']) . ' .js-quickEditTarget"
	...
	if ($__templater->method($__vars['profilePost'], 'canDelete', array('soft', ))) {
		$__compilerTemp2 .= '
										<a href="' . $__templater->func('link', array('owner-page-posts/delete', $__vars['profilePost'], ), true) . '"
	...
	if (($__vars['profilePost']['message_state'] == 'deleted') AND $__templater->method($__vars['profilePost'], 'canUndelete', array())) {
		$__compilerTemp2 .= '
										<a href="' . $__templater->func('link', array('owner-page-posts/undelete', $__vars['profilePost'], ), true) . '" data-xf-click="overlay"
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canViewIps', array()) AND $__vars['profilePost']['ip_id']) {
		$__compilerTemp2 .= '
										<a href="' . $__templater->func('link', array('owner-page-posts/ip', $__vars['profilePost'], ), true) . '"
	...
	if ($__templater->method($__vars['profilePost'], 'canWarn', array())) {
		$__compilerTemp2 .= '
										<a href="' . $__templater->func('link', array('owner-page-posts/warn', $__vars['profilePost'], ), true) . '"
	...
	if ($__vars['profilePost']['reactions']) {
		$__finalCompiled .= '
								' . $__templater->func('reactions', array($__vars['profilePost'], 'owner-page-posts/reactions', array())) . '
							';
	}
	$__finalCompiled .= '</div>
		...
		if ($__templater->method($__vars['profilePost'], 'hasMoreComments', array())) {
			$__finalCompiled .= '
									<div class="message-responseRow u-jsOnly js-commentLoader">
										<a href="' . $__templater->func('link', array('owner-page-posts/load-previous', $__vars['profilePost'], array('before' => $__templater->arrayKey($__templater->method($__vars['profilePost']['LatestComments'], 'first', array()), 'comment_date'), ), ), true) . '"
	...
	if ($__templater->method($__vars['profilePost'], 'canComment', array())) {
		...
		$__finalCompiled .= '
								<div class="message-responseRow js-commentsTarget-' . $__templater->escape($__vars['profilePost']['post_id']) . ' ' . ($__templater->func('property', array('ownerPagePostCommentToggle', ), false) ? 'toggleTarget' : '') . '">
									';
		...
		$__finalCompiled .= $__templater->form('
			...
			'simpleSubmit' => true,
									...
									', array(
			'action' => $__templater->func('link', array('owner-page-posts/add-comment', $__vars['profilePost'], ), false),
			'ajax' => 'true',
			'class' => 'comment',
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="message message--simple' . ($__templater->method($__vars['profilePost'], 'isIgnored', array()) ? ' is-ignored' : '') . ' js-inlineModContainer"
		...
		'log' => $__vars['profilePost']['DeletionLog'],
					...
					<a href="' . $__templater->func('link', array('owner-page-posts/show', $__vars['profilePost'], ), true) . '" class="u-jsOnly" data-xf-click="inserter" data-replace="[data-content=profile-post-' . $__templater->escape($__vars['profilePost']['post_id']) . ']">' . 'Show' . $__vars['xf']['language']['ellipsis'] . '</a>
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
		...
		$__finalCompiled .= '
				<div class="contentRow-faderContainer">
					<div class="contentRow-faderContent">
						' . $__templater->func('bb_code', array($__vars['profilePost']['message'], 'bh_ownerPage_post', $__vars['profilePost'], array('simpleUnfurl' => true, ), ), true) . '
					</div>
	...
	$__finalCompiled .= '
			...
			<div class="contentRow-minor">
				<a href="' . $__templater->func('link', array('owner-page-posts', $__vars['profilePost'], ), true) . '" rel="nofollow" class="u-concealed">' . $__templater->func('date_dynamic', array($__vars['profilePost']['post_date'], array(
	))) . '</a>
				<a href="' . $__templater->func('link', array('owner-page-posts', $__vars['profilePost'], ), true) . '" rel="nofollow" class="contentRow-extra" data-xf-click="overlay" data-xf-init="tooltip" title="' . $__templater->filter('Interact', array(array('for_attr', array()),), true) . '">&#8226;&#8226;&#8226;</a>
			</div>
		</div>
	</div>
';
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="message-responseRow ' . ($__templater->method($__vars['comment'], 'isIgnored', array()) ? 'is-ignored' : '') . '">
		<div class="comment"
			...
			data-content="profile-post-comment-' . $__templater->escape($__vars['comment']['post_comment_id']) . '"
			id="js-profilePostComment-' . $__templater->escape($__vars['comment']['post_comment_id']) . '">
		...
		'defaultname' => $__vars['comment']['username'],
				...
				<div class="comment-main">
					<span class="u-anchorTarget" id="profile-post-comment-' . $__templater->escape($__vars['comment']['post_comment_id']) . '"></span>
	...
	$__finalCompiled .= '
		...
		'class' => 'comment-user',
								...
								<div class="lbContainer js-lbContainer"
									data-lb-id="profile-post-comment-' . $__templater->escape($__vars['comment']['post_comment_id']) . '"
									...
									<article class="comment-body">
										' . $__templater->func('bb_code', array($__vars['comment']['message'], 'bh_ownerPage_post_comment', $__vars['comment'], ), true) . '
									</article>
									';
	...
	if ($__templater->method($__vars['comment'], 'canReport', array())) {
		$__finalCompiled .= '
										<a href="' . $__templater->func('link', array('owner-page-posts/comments/report', $__vars['comment'], ), true) . '"
	...
	if ($__templater->method($__vars['comment'], 'canEdit', array())) {
		...
		$__finalCompiled .= '
										<a href="' . $__templater->func('link', array('owner-page-posts/comments/edit', $__vars['comment'], ), true) . '"
											class="actionBar-action actionBar-action--edit actionBar-action--menuItem"
											data-xf-click="quick-edit"
											data-editor-target="#js-profilePostComment-' . $__templater->escape($__vars['comment']['post_comment_id']) . ' .js-quickEditTargetComment"
											data-menu-closer="true">' . 'Edit' . '</a>
										';
		$__vars['hasActionBarMenu'] = true;
		$__finalCompiled .= '
	...
	if ($__templater->method($__vars['comment'], 'canDelete', array('soft', ))) {
		$__finalCompiled .= '
										<a href="' . $__templater->func('link', array('owner-page-posts/comments/delete', $__vars['comment'], ), true) . '"
											class="actionBar-action actionBar-action--delete actionBar-action--menuItem"
											data-xf-click="overlay">' . 'Delete' . '</a>
										';
		$__vars['hasActionBarMenu'] = true;
	...
	if (($__vars['comment']['message_state'] == 'deleted') AND $__templater->method($__vars['comment'], 'canUndelete', array())) {
		$__finalCompiled .= '
										<a href="' . $__templater->func('link', array('owner-page-posts/comments/undelete', $__vars['comment'], ), true) . '" data-xf-click="overlay"
											class="actionBar-action actionBar-action--undelete actionBar-action--menuItem">' . 'Undelete' . '</a>
										';
		$__vars['hasActionBarMenu'] = true;
		$__finalCompiled .= '
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canViewIps', array()) AND $__vars['comment']['ip_id']) {
		$__finalCompiled .= '
										<a href="' . $__templater->func('link', array('owner-page-posts/comments/ip', $__vars['comment'], ), true) . '"
											class="actionBar-action actionBar-action--ip actionBar-action--menuItem"
											data-xf-click="overlay">' . 'IP' . '</a>
										';
		$__vars['hasActionBarMenu'] = true;
	...
	if ($__templater->method($__vars['comment'], 'canWarn', array())) {
		$__finalCompiled .= '
										<a href="' . $__templater->func('link', array('owner-page-posts/comments/warn', $__vars['comment'], ), true) . '"
											class="actionBar-action actionBar-action--warn actionBar-action--menuItem">' . 'Warn' . '</a>
										';
		$__vars['hasActionBarMenu'] = true;
		$__finalCompiled .= '
	...
	if ($__templater->method($__vars['comment'], 'canApproveUnapprove', array())) {
		...
		if ($__vars['comment']['message_state'] == 'moderated') {
			$__finalCompiled .= '
											<a href="' . $__templater->func('link', array('owner-page-posts/comments/approve', $__vars['comment'], array('t' => $__templater->func('csrf_token', array(), false), ), ), true) . '"
			...
			$__finalCompiled .= '
											<a href="' . $__templater->func('link', array('owner-page-posts/comments/unapprove', $__vars['comment'], array('t' => $__templater->func('csrf_token', array(), false), ), ), true) . '"
	...
	$__compilerTemp1 .= '
		...
		'link' => 'owner-page-posts/comments/react',
	...
	if ($__vars['comment']['reactions']) {
		$__finalCompiled .= '
								' . $__templater->func('reactions', array($__vars['comment'], 'owner-page-posts/comments/reactions', array())) . '
							';
	}
	$__finalCompiled .= '</div>
						</footer>
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="message-responseRow">
		...
		'log' => $__vars['comment']['DeletionLog'],
							...
							<a href="' . $__templater->func('link', array('owner-page-posts/comments/show', $__vars['comment'], ), true) . '" class="u-jsOnly"
								data-xf-click="inserter"
								data-replace="[data-content=profile-post-comment-' . $__templater->escape($__vars['comment']['post_comment_id']) . ']">' . 'Show' . $__vars['xf']['language']['ellipsis'] . '</a>
						</div>
					</div>
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . $__templater->form('
		...
		'attachmentData' => $__vars['attachmentData'],
		'simple' => true,
		'placeholder' => (($__vars['xf']['visitor']['user_id'] == $__vars['ownerPage']['user_id']) ? 'Leave update' . $__vars['xf']['language']['ellipsis'] : 'Leave a comment' . $__vars['xf']['language']['ellipsis']),
		'submitText' => 'Post',
	...
	', array(
		'action' => $__templater->func('link', array('owners/post', $__vars['ownerPage'], ), false),
		'ajax' => 'true',
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
	$__vars['placeholder'] = (($__vars['xf']['visitor']['user_id'] == $__vars['ownerPage']['user_id']) ? 'Leave update' . $__vars['xf']['language']['ellipsis'] : 'Leave a comment' . $__vars['xf']['language']['ellipsis']);
	$__finalCompiled .= '
	...
	if ($__vars['style'] == 'full') {
		...
		$__compilerTemp1 .= '
			<div>
				<span class="u-srOnly" id="ctrl_message">' . 'Leave update' . $__vars['xf']['language']['label_separator'] . '</span>
