...
(a.find(".bx-progress").show(),m()):p()},onSlideBefore:function(e,g,c){newPlayer="youTube"+(c+1);newPlayer in d&&d[newPlayer].playVideo();m()},onSlideAfter:function(e,g,c){oldPlayer="youTube"+(g+1);oldPlayer in d&&d[oldPlayer].stopVideo()},onSliderLoad:function(e){setTimeout(function(){newPlayer="youTube"+(e+1);newPlayer in d&&d[newPlayer].playVideo()},4E3)}})}});XF.Element.register("porta-upload","EWRporta.Upload");XF.Element.register("porta-masonry","EWRporta.Masonry");XF.Element.register("porta-infinite",
"EWRporta.Infinite");XF.Element.register("porta-features","EWRporta.Features")}(window.jQuery,window,document);