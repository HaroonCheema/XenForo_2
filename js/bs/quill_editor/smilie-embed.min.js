...
!function(a,c,b){var d=Quill["import"]("blots/embed"),e=Quill["import"]("delta");a=function(){return d.apply(this,arguments)||this};$jscomp.inherits(a,d);a.create=function(f){var g=d.create.call(this,f);f=f.attributes||[];for(var k in f){var h=f[k];g.setAttribute(h.name,h.value)}return g};a.value=function(f){var g;return null==(g=f.querySelector("img"))?void 0:g.getAttribute("data-shortcut")};a.blotName="smilie";a.tagName="img";a.className="smilie";Quill.register("modules/smilieImg",function(f,g){f.clipboard.addMatcher("img.smilie",
function(k,h){var l={smilie:{attributes:Array.from(k.attributes)}};l=(new e).insert(l);return h=h.compose(l)})});Quill.register(a,!0)}(jQuery,window,document);