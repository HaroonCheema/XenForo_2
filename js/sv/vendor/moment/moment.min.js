...
c+=6E4-pa(c,6E4)-1;break;case "second":c=this._d.valueOf(),c+=1E3-pa(c,1E3)-1}this._d.setTime(c);k.updateOffset(this,!0);return this};g.format=function(a){a||=this.isUtc()?k.defaultFormatUtc:k.defaultFormat;a=Fa(this,a);return this.localeData().postformat(a)};g.from=function(a,b){return this.isValid()&&(O(a)&&a.isValid()||z(a).isValid())?Q({to:this,from:a}).locale(this.locale()).humanize(!b):this.localeData().invalidDate()};g.fromNow=function(a){return this.from(z(),a)};g.to=function(a,b){return this.isValid()&&
