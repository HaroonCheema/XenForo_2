...
(function(L,E){"object"===typeof exports&&"undefined"!==typeof module?module.exports=E():"function"===typeof define&&define.amd?define(E):(L="undefined"!==typeof globalThis?globalThis:L||self,L.Choices=E())})(this,function(){function L(b,a){function c(){this.constructor=b}if("function"!==typeof a&&null!==a)throw new TypeError("Class extends value "+String(a)+" is not a constructor or null");U(b,a);b.prototype=null===a?Object.create(a):(c.prototype=a.prototype,new c)}function E(b,a,c){if(c||2===arguments.length)for(var d=
0,e=a.length,f;d<e;d++)!f&&d in a||(f||=Array.prototype.slice.call(a,0,d),f[d]=a[d]);return b.concat(f||Array.prototype.slice.call(a))}function aa(b,a){var c=Object.keys(b);if(Object.getOwnPropertySymbols){var d=Object.getOwnPropertySymbols(b);a&&(d=d.filter(function(e){return Object.getOwnPropertyDescriptor(b,e).enumerable}));c.push.apply(c,d)}return c}function M(b){for(var a=1;a<arguments.length;a++){var c=null!=arguments[a]?arguments[a]:{};a%2?aa(Object(c),!0).forEach(function(d){var e,f=c[d];
a:if("object"==typeof d&&d){var g=d[Symbol.toPrimitive];if(void 0!==g){d=g.call(d,"string");if("object"!=typeof d)break a;throw new TypeError("@@toPrimitive must return a primitive value.");}d=String(d)}(e="symbol"==typeof d?d:d+"")in b?Object.defineProperty(b,e,{value:f,enumerable:!0,configurable:!0,writable:!0}):b[e]=f}):Object.getOwnPropertyDescriptors?Object.defineProperties(b,Object.getOwnPropertyDescriptors(c)):aa(Object(c)).forEach(function(d){Object.defineProperty(b,d,Object.getOwnPropertyDescriptor(c,
d))})}return b}function F(b){return Array.isArray?Array.isArray(b):"[object Array]"===ba(b)}function G(b){return"string"===typeof b}function D(b){return void 0!==b&&null!==b}function ba(b){return null==b?void 0===b?"[object Undefined]":"[object Null]":Object.prototype.toString.call(b)}function ca(b){let a;let c,d=1,e=null;if(G(b)||F(b)){c=b;a=F(b)?b:b.split(".");var f=V(b)}else{if(!da.call(b,"name"))throw Error("Missing name property in key");c=f=b.name;if(da.call(b,"weight")&&(d=b.weight,0>=d))throw Error(`Property 'weight' in key '${f}' must be a positive integer`);
a=F(f)?f:f.split(".");f=V(f);e=b.getFn}return{path:a,id:f,weight:d,src:c,getFn:e}}function V(b){return F(b)?b.join("."):b}function sa(b=1,a=3){const c=new Map,d=Math.pow(10,a);return{get(e){e=e.match(ta).length;if(c.has(e))return c.get(e);const f=parseFloat(Math.round(1/Math.pow(e,.5*b)*d)/d);c.set(e,f);return f},clear(){c.clear()}}}function ea(b,a,{getFn:c=q.getFn,fieldNormWeight:d=q.fieldNormWeight}={}){c=new W({getFn:c,fieldNormWeight:d});c.setKeys(b.map(ca));c.setSources(a);c.create();return c}
function Q(b,{errors:a=0,currentLocation:c=0,expectedLocation:d=0,distance:e=q.distance,ignoreLocation:f=q.ignoreLocation}={}){b=a/b.length;if(f)return b;c=Math.abs(d-c);return e?b+c/e:c?1:b}function ua(b=[],a=q.minMatchCharLength){let c=[],d=-1;var e;let f=0;for(let g=b.length;f<g;f+=1)(e=b[f])&&-1===d?d=f:e||-1===d||(e=f-1,e-d+1>=a&&c.push([d,e]),d=-1);b[f-1]&&f-d>=a&&c.push([d,f-1]);return c}function va(b,a,c,{location:d=q.location,distance:e=q.distance,threshold:f=q.threshold,findAllMatches:g=
q.findAllMatches,minMatchCharLength:h=q.minMatchCharLength,includeMatches:k=q.includeMatches,ignoreLocation:l=q.ignoreLocation}={}){if(32<a.length)throw Error("Pattern length exceeds max of 32.");const p=a.length,u=b.length;d=Math.max(0,Math.min(d,u));let x=f;var w=d;const y=(f=1<h||k)?Array(u):[];for(var v;-1<(v=b.indexOf(a,w));)if(w=Q(a,{currentLocation:v,expectedLocation:d,distance:e,ignoreLocation:l}),x=Math.min(w,x),w=v+p,f)for(var r=0;r<p;)y[v+r]=1,r+=1;w=-1;v=[];r=1;let n=p+u;const C=1<<p-
1;for(let J=0;J<p;J+=1){for(var A=0,z=n;A<z;)Q(a,{errors:J,currentLocation:d+z,expectedLocation:d,distance:e,ignoreLocation:l})<=x?A=z:n=z,z=Math.floor((n-A)/2+A);n=z;A=Math.max(1,d-z+1);var t=g?u:Math.min(d+z,u)+p;z=Array(t+2);for(z[t+1]=(1<<J)-1;t>=A;--t){let R=t-1,fa=c[b.charAt(R)];f&&(y[R]=+!!fa);z[t]=(z[t+1]<<1|1)&fa;J&&(z[t]=z[t]|(v[t+1]|v[t])<<1|1|v[t+1]);if(z[t]&C&&(r=Q(a,{errors:J,currentLocation:R,expectedLocation:d,distance:e,ignoreLocation:l}),r<=x)){x=r;w=R;if(w<=d)break;A=Math.max(1,
2*d-w)}}if(Q(a,{errors:J+1,currentLocation:d,expectedLocation:d,distance:e,ignoreLocation:l})>x)break;v=z}b={isMatch:0<=w,score:Math.max(.001,r)};f&&((h=ua(y,h),h.length)?k&&(b.indices=h):b.isMatch=!1);return b}function X(b,a){for(let c=0,d=ha.length;c<d;c+=1){let e=ha[c];if(e.condition(b,a))return new e(b,a)}return new wa(b,a)}function xa(b,{ignoreFieldNorm:a=q.ignoreFieldNorm}){b.forEach(c=>{let d=1;c.matches.forEach(({key:e,norm:f,score:g})=>{e=e?e.weight:null;d*=Math.pow(0===g&&e?Number.EPSILON:
g,(e||1)*(a?1:f))});c.score=d})}function ya(b,a){b=b.matches;a.matches=[];D(b)&&b.forEach(c=>{if(D(c.indices)&&c.indices.length){var {indices:d,value:e}=c,f={indices:d,value:e};c.key&&(f.key=c.key.src);-1<c.idx&&(f.refIndex=c.idx);a.matches.push(f)}})}function za(b,a){a.score=b.score}function Aa(b,a,{includeMatches:c=q.includeMatches,includeScore:d=q.includeScore}={}){const e=[];c&&e.push(ya);d&&e.push(za);return b.map(f=>{const {idx:g}=f,h={item:a[g],refIndex:g};e.length&&e.forEach(k=>{k(f,h)});
return h})}var U=function(b,a){U=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(c,d){c.__proto__=d}||function(c,d){for(var e in d)Object.prototype.hasOwnProperty.call(d,e)&&(c[e]=d[e])};return U(b,a)},B=function(){B=Object.assign||function(b){for(var a,c=1,d=arguments.length;c<d;c++){a=arguments[c];for(var e in a)Object.prototype.hasOwnProperty.call(a,e)&&(b[e]=a[e])}return b};return B.apply(this,arguments)};"function"===typeof SuppressedError?SuppressedError:function(b,a,c){c=Error(c);
return c.name="SuppressedError",c.error=b,c.suppressed=a,c};var Ba=["fuseOptions","classNames"],ia=function(b){return Array.from({length:b},function(){return Math.floor(36*Math.random()).toString(36)}).join("")},Ca=function(b,a){b=b.id||b.name&&"".concat(b.name,"-").concat(ia(2))||ia(4);b=b.replace(/(:|\.|\[|\]|,)/g,"");return b="".concat(a,"-").concat(b)},S=function(b){if("string"!==typeof b){if(null===b||void 0===b)return"";if("object"===typeof b){if("raw"in b)return S(b.raw);if("trusted"in b)return b.trusted}return b}return b.replace(/&/g,
"&amp;").replace(/>/g,"&gt;").replace(/</g,"&lt;").replace(/'/g,"&#039;").replace(/"/g,"&quot;")},Da=function(){var b=document.createElement("div");return function(a){b.innerHTML=a.trim();for(a=b.children[0];b.firstChild;)b.removeChild(b.firstChild);return a}}(),O=function(b,a){return"function"===typeof b?b(S(a),a):b},ja=function(b){return"function"===typeof b?b():b},K=function(b){if("string"===typeof b)return b;if("object"===typeof b){if("trusted"in b)return b.trusted;if("raw"in b)return b.raw}return""},
Ea=function(b){if("string"===typeof b)return b;if("object"===typeof b){if("escaped"in b)return b.escaped;if("trusted"in b)return b.trusted}return""},H=function(b,a){return b?Ea(a):S(a)},Fa=function(b,a){return b.rank-a.rank},Ga=function(b,a){b=Object.keys(b).sort();var c=Object.keys(a).sort();return b.filter(function(d){return 0>c.indexOf(d)})},m=function(b){return Array.isArray(b)?b:[b]},T=function(b){return b&&Array.isArray(b)?b.map(function(a){return".".concat(a)}).join(""):".".concat(b)},Ha=function(){function b(a){var c=
a.type,d=a.classNames;this.element=a.element;this.classNames=d;this.type=c;this.isActive=!1}Object.defineProperty(b.prototype,"distanceFromTopWindow",{get:function(){return this.element.getBoundingClientRect().bottom},enumerable:!1,configurable:!0});b.prototype.show=function(){var a;(a=this.element.classList).add.apply(a,m(this.classNames.activeState));this.element.setAttribute("aria-expanded","true");this.isActive=!0;return this};b.prototype.hide=function(){var a;(a=this.element.classList).remove.apply(a,
m(this.classNames.activeState));this.element.setAttribute("aria-expanded","false");this.isActive=!1;return this};return b}(),ka=function(){function b(a){var c=a.type,d=a.classNames,e=a.position;this.element=a.element;this.classNames=d;this.type=c;this.position=e;this.isLoading=this.isDisabled=this.isFlipped=this.isOpen=!1}b.prototype.shouldFlip=function(a){var c=!1;"auto"===this.position?c=!window.matchMedia("(min-height: ".concat(a+1,"px)")).matches:"top"===this.position&&(c=!0);return c};b.prototype.setActiveDescendant=
function(a){this.element.setAttribute("aria-activedescendant",a)};b.prototype.removeActiveDescendant=function(){this.element.removeAttribute("aria-activedescendant")};b.prototype.open=function(a){var c,d;(c=this.element.classList).add.apply(c,m(this.classNames.openState));this.element.setAttribute("aria-expanded","true");this.isOpen=!0;this.shouldFlip(a)&&((d=this.element.classList).add.apply(d,m(this.classNames.flippedState)),this.isFlipped=!0)};b.prototype.close=function(){var a,c;(a=this.element.classList).remove.apply(a,
m(this.classNames.openState));this.element.setAttribute("aria-expanded","false");this.removeActiveDescendant();this.isOpen=!1;this.isFlipped&&((c=this.element.classList).remove.apply(c,m(this.classNames.flippedState)),this.isFlipped=!1)};b.prototype.addFocusState=function(){var a;(a=this.element.classList).add.apply(a,m(this.classNames.focusState))};b.prototype.removeFocusState=function(){var a;(a=this.element.classList).remove.apply(a,m(this.classNames.focusState))};b.prototype.enable=function(){var a;
(a=this.element.classList).remove.apply(a,m(this.classNames.disabledState));this.element.removeAttribute("aria-disabled");"select-one"===this.type&&this.element.setAttribute("tabindex","0");this.isDisabled=!1};b.prototype.disable=function(){var a;(a=this.element.classList).add.apply(a,m(this.classNames.disabledState));this.element.setAttribute("aria-disabled","true");"select-one"===this.type&&this.element.setAttribute("tabindex","-1");this.isDisabled=!0};b.prototype.wrap=function(a){var c=a.parentNode;
c&&(a.nextSibling?c.insertBefore(this.element,a.nextSibling):c.appendChild(this.element));this.element.appendChild(a)};b.prototype.unwrap=function(a){var c=this.element.parentNode;c&&(c.insertBefore(a,this.element),c.removeChild(this.element))};b.prototype.addLoadingState=function(){var a;(a=this.element.classList).add.apply(a,m(this.classNames.loadingState));this.element.setAttribute("aria-busy","true");this.isLoading=!0};b.prototype.removeLoadingState=function(){var a;(a=this.element.classList).remove.apply(a,
m(this.classNames.loadingState));this.element.removeAttribute("aria-busy");this.isLoading=!1};return b}(),Ia=function(){function b(a){var c=a.element,d=a.type,e=a.classNames;a=a.preventPaste;this.element=c;this.type=d;this.classNames=e;this.preventPaste=a;this.isFocussed=this.element.isEqualNode(document.activeElement);this.isDisabled=c.disabled;this._onPaste=this._onPaste.bind(this);this._onInput=this._onInput.bind(this);this._onFocus=this._onFocus.bind(this);this._onBlur=this._onBlur.bind(this)}
Object.defineProperty(b.prototype,"placeholder",{set:function(a){this.element.placeholder=a},enumerable:!1,configurable:!0});Object.defineProperty(b.prototype,"value",{get:function(){return this.element.value},set:function(a){this.element.value=a},enumerable:!1,configurable:!0});b.prototype.addEventListeners=function(){var a=this.element;a.addEventListener("paste",this._onPaste);a.addEventListener("input",this._onInput,{passive:!0});a.addEventListener("focus",this._onFocus,{passive:!0});a.addEventListener("blur",
this._onBlur,{passive:!0})};b.prototype.removeEventListeners=function(){var a=this.element;a.removeEventListener("input",this._onInput);a.removeEventListener("paste",this._onPaste);a.removeEventListener("focus",this._onFocus);a.removeEventListener("blur",this._onBlur)};b.prototype.enable=function(){this.element.removeAttribute("disabled");this.isDisabled=!1};b.prototype.disable=function(){this.element.setAttribute("disabled","");this.isDisabled=!0};b.prototype.focus=function(){this.isFocussed||this.element.focus()};
b.prototype.blur=function(){this.isFocussed&&this.element.blur()};b.prototype.clear=function(a){void 0===a&&(a=!0);this.element.value="";a&&this.setWidth();return this};b.prototype.setWidth=function(){var a=this.element,c=a.style,d=a.value;c.minWidth="".concat(a.placeholder.length+1,"ch");c.width="".concat(d.length+1,"ch")};b.prototype.setActiveDescendant=function(a){this.element.setAttribute("aria-activedescendant",a)};b.prototype.removeActiveDescendant=function(){this.element.removeAttribute("aria-activedescendant")};
b.prototype._onInput=function(){"select-one"!==this.type&&this.setWidth()};b.prototype._onPaste=function(a){this.preventPaste&&a.preventDefault()};b.prototype._onFocus=function(){this.isFocussed=!0};b.prototype._onBlur=function(){this.isFocussed=!1};return b}(),la=function(){function b(a){this.element=a.element;this.scrollPos=this.element.scrollTop;this.height=this.element.offsetHeight}b.prototype.clear=function(){this.element.innerHTML=""};b.prototype.prepend=function(a){var c=this.element.firstElementChild;
c?this.element.insertBefore(a,c):this.element.append(a)};b.prototype.scrollToTop=function(){this.element.scrollTop=0};b.prototype.scrollToChildElement=function(a,c){var d=this;if(a){var e=this.element.scrollTop+this.element.offsetHeight,f=a.offsetTop+a.offsetHeight,g=0<c?this.element.scrollTop+f-e:a.offsetTop;requestAnimationFrame(function(){d._animateScroll(g,c)})}};b.prototype._scrollDown=function(a,c,d){c=(d-a)/c;this.element.scrollTop=a+(1<c?c:1)};b.prototype._scrollUp=function(a,c,d){c=(a-d)/
c;this.element.scrollTop=a-(1<c?c:1)};b.prototype._animateScroll=function(a,c){var d=this,e=this.element.scrollTop,f=!1;0<c?(this._scrollDown(e,4,a),e<a&&(f=!0)):(this._scrollUp(e,4,a),e>a&&(f=!0));f&&requestAnimationFrame(function(){d._animateScroll(a,c)})};return b}(),ma=function(){function b(a){var c=a.classNames;this.element=a.element;this.classNames=c;this.isDisabled=!1}Object.defineProperty(b.prototype,"isActive",{get:function(){return"active"===this.element.dataset.choice},enumerable:!1,configurable:!0});
Object.defineProperty(b.prototype,"dir",{get:function(){return this.element.dir},enumerable:!1,configurable:!0});Object.defineProperty(b.prototype,"value",{get:function(){return this.element.value},set:function(a){this.element.setAttribute("value",a);this.element.value=a},enumerable:!1,configurable:!0});b.prototype.conceal=function(){var a,c=this.element;(a=c.classList).add.apply(a,m(this.classNames.input));c.hidden=!0;c.tabIndex=-1;(a=c.getAttribute("style"))&&c.setAttribute("data-choice-orig-style",
a);c.setAttribute("data-choice","active")};b.prototype.reveal=function(){var a,c=this.element;(a=c.classList).remove.apply(a,m(this.classNames.input));c.hidden=!1;c.removeAttribute("tabindex");(a=c.getAttribute("data-choice-orig-style"))?(c.removeAttribute("data-choice-orig-style"),c.setAttribute("style",a)):c.removeAttribute("style");c.removeAttribute("data-choice")};b.prototype.enable=function(){var a=this.element;a.removeAttribute("disabled");this.isDisabled=a.disabled=!1};b.prototype.disable=
function(){var a=this.element;a.setAttribute("disabled","");this.isDisabled=a.disabled=!0};b.prototype.triggerEvent=function(a,c){var d=this.element;c=c||{};void 0===c&&(c=null);a=new CustomEvent(a,{detail:c,bubbles:!0,cancelable:!0});d.dispatchEvent(a)};return b}(),Ja=function(b){function a(){return null!==b&&b.apply(this,arguments)||this}L(a,b);return a}(ma),P=function(b,a){void 0===a&&(a=!0);return"undefined"===typeof b?a:!!b},na=function(b){"string"===typeof b&&(b=b.split(" ").filter(function(a){return a.length}));
if(Array.isArray(b)&&b.length)return b},I=function(b,a){if("string"===typeof b)return I({value:b,label:b},!1);if("choices"in b){if(!a)throw new TypeError("optGroup is not allowed");a=b.choices.map(function(c){return I(c,!1)});return{id:0,label:K(b.label)||b.value,active:!!a.length,disabled:!!b.disabled,choices:a}}return{id:0,groupId:0,score:0,rank:0,value:b.value,label:b.label||b.value,active:P(b.active),selected:P(b.selected,!1),disabled:P(b.disabled,!1),placeholder:P(b.placeholder,!1),highlighted:!1,
labelClass:na(b.labelClass),labelDescription:b.labelDescription,customProperties:b.customProperties}},Ka=function(b){function a(c){var d=c.template,e=c.extractPlaceholder;c=b.call(this,{element:c.element,classNames:c.classNames})||this;c.template=d;c.extractPlaceholder=e;return c}L(a,b);Object.defineProperty(a.prototype,"placeholderOption",{get:function(){return this.element.querySelector('option[value=""]')||this.element.querySelector("option[placeholder]")},enumerable:!1,configurable:!0});a.prototype.addOptions=
function(c){var d=this,e=document.createDocumentFragment();c.forEach(function(f){if(!f.element){var g=d.template(f);e.appendChild(g);f.element=g}});this.element.appendChild(e)};a.prototype.optionsAsChoices=function(){var c=this,d=[];this.element.querySelectorAll(":scope > option, :scope > optgroup").forEach(function(e){"OPTION"===e.tagName?d.push(c._optionToChoice(e)):"OPTGROUP"===e.tagName&&d.push(c._optgroupToChoice(e))});return d};a.prototype._optionToChoice=function(c){!c.hasAttribute("value")&&
c.hasAttribute("placeholder")&&(c.setAttribute("value",""),c.value="");var d=c.dataset,e=c.value,f=c.innerHTML,g=this.extractPlaceholder?c.selected:c.hasAttribute("selected"),h=c.disabled,k=this.extractPlaceholder&&(!c.value||c.hasAttribute("placeholder")),l="undefined"!==typeof d.labelClass?na(d.labelClass):void 0,p="undefined"!==typeof d.labelDescription?d.labelDescription:void 0;a:{d=d.customProperties;if("undefined"!==typeof d)try{var u=JSON.parse(d);break a}catch(x){u=d;break a}u={}}return{id:0,
groupId:0,score:0,rank:0,value:e,label:f,element:c,active:!0,selected:g,disabled:h,highlighted:!1,placeholder:k,labelClass:l,labelDescription:p,customProperties:u}};a.prototype._optgroupToChoice=function(c){var d=this,e=c.querySelectorAll("option");e=Array.from(e).map(function(f){return d._optionToChoice(f)});return{id:0,label:c.label||"",element:c,active:!!e.length,disabled:c.disabled,choices:e}};return a}(ma),oa={items:[],choices:[],silent:!1,renderChoiceLimit:-1,maxItemCount:-1,closeDropdownOnSelect:"auto",
singleModeForMultiSelect:!1,addChoices:!1,addItems:!0,addItemFilter:function(b){return!!b&&""!==b},removeItems:!0,removeItemButton:!1,removeItemButtonAlignLeft:!1,editItems:!1,allowHTML:!1,allowHtmlUserInput:!1,duplicateItemsAllowed:!0,delimiter:",",paste:!0,searchEnabled:!0,searchChoices:!0,searchFloor:1,searchResultLimit:4,searchFields:["label","value"],position:"auto",resetScrollPosition:!0,shouldSort:!0,shouldSortItems:!1,sorter:function(b,a){var c=b.value;b=b.label;var d=a.value;a=a.label;a=
void 0===a?d:a;return K(void 0===b?c:b).localeCompare(K(a),[],{sensitivity:"base",ignorePunctuation:!0,numeric:!0})},shadowRoot:null,placeholder:!0,placeholderValue:null,searchPlaceholderValue:null,prependValue:null,appendValue:null,renderSelectedChoices:"auto",loadingText:"Loading...",noResultsText:"No results found",noChoicesText:"No choices to choose from",itemSelectText:"Press to select",uniqueItemText:"Only unique values can be added",customAddItemText:"Only values matching specific conditions can be added",
addItemText:function(b){return'Press Enter to add <b>"'.concat(b,'"</b>')},removeItemIconText:function(){return"Remove item"},removeItemLabelText:function(b){return"Remove item: ".concat(b)},maxItemText:function(b){return"Only ".concat(b," values can be added")},valueComparer:function(b,a){return b===a},fuseOptions:{includeScore:!0},labelId:"",callbackOnInit:null,callbackOnCreateTemplates:null,classNames:{containerOuter:["choices"],containerInner:["choices__inner"],input:["choices__input"],inputCloned:["choices__input--cloned"],
...
disabledState:["is-disabled"],highlightedState:["is-highlighted"],selectedState:["is-selected"],flippedState:["is-flipped"],loadingState:["is-loading"],notice:["choices__notice"],addChoice:["choices__item--selectable","add-choice"],noResults:["has-no-results"],noChoices:["has-no-choices"]},appendGroupInSearch:!1},pa={groups:function(b,a){var c=!0;switch(a.type){case "ADD_GROUP":b.push(a.group);break;case "CLEAR_CHOICES":b=[];break;default:c=!1}return{state:b,update:c}},items:function(b,a){var c=!0;
switch(a.type){case "ADD_ITEM":var d=a.item;d.selected=!0;var e=d.element;e&&(e.selected=!0,e.setAttribute("selected",""));b.push(d);b.forEach(function(g){g.highlighted=!1});break;case "REMOVE_ITEM":var f=a.item;f.selected=!1;if(e=f.element)e.selected=!1,e.removeAttribute("selected"),(d=e.parentElement)&&"SELECT"===d.tagName&&"select-one"===d.type&&(d.value="");b=b.filter(function(g){return g.id!==f.id});break;case "REMOVE_CHOICE":b=b.filter(function(g){return g.id!==a.choice.id});break;case "HIGHLIGHT_ITEM":b.forEach(function(g){g.id===
a.item.id&&(g.highlighted=a.highlighted)});break;default:c=!1}return{state:b,update:c}},choices:function(b,a){var c=!0;switch(a.type){case "ADD_CHOICE":b.push(a.choice);break;case "REMOVE_CHOICE":b=b.filter(function(e){return e.id!==a.choice.id});break;case "ADD_ITEM":case "REMOVE_ITEM":break;case "FILTER_CHOICES":var d=[];a.results.forEach(function(e){d[e.item.id]=e});b.forEach(function(e){var f=d[e.id];void 0!==f?(e.score=f.score,e.rank=f.rank,e.active=!0):(e.score=0,e.rank=0,e.active=!1)});break;
case "ACTIVATE_CHOICES":b.forEach(function(e){e.active=a.active});break;case "CLEAR_CHOICES":b=[];break;default:c=!1}return{state:b,update:c}}},La=function(){function b(){this._state=this.defaultState;this._listeners=[];this._txn=0}Object.defineProperty(b.prototype,"defaultState",{get:function(){return{groups:[],items:[],choices:[]}},enumerable:!1,configurable:!0});b.prototype.changeSet=function(a){return{groups:a,items:a,choices:a}};b.prototype.reset=function(){this._state=this.defaultState;var a=
this.changeSet(!0);this._txn?this._changeSet=a:this._listeners.forEach(function(c){return c(a)})};b.prototype.subscribe=function(a){this._listeners.push(a)};b.prototype.dispatch=function(a){var c=this._state,d=!1,e=this._changeSet||this.changeSet(!1);Object.keys(pa).forEach(function(f){var g=pa[f](c[f],a);g.update&&(d=!0,e[f]=!0,c[f]=g.state)});d&&(this._txn?this._changeSet=e:this._listeners.forEach(function(f){return f(e)}))};b.prototype.withTxn=function(a){this._txn++;try{a()}finally{if(this._txn=
Math.max(0,this._txn-1),!this._txn){var c=this._changeSet;c&&(this._changeSet=void 0,this._listeners.forEach(function(d){return d(c)}))}}};Object.defineProperty(b.prototype,"state",{get:function(){return this._state},enumerable:!1,configurable:!0});Object.defineProperty(b.prototype,"items",{get:function(){return this.state.items},enumerable:!1,configurable:!0});Object.defineProperty(b.prototype,"highlightedActiveItems",{get:function(){return this.items.filter(function(a){return!a.disabled&&a.active&&
a.highlighted})},enumerable:!1,configurable:!0});Object.defineProperty(b.prototype,"choices",{get:function(){return this.state.choices},enumerable:!1,configurable:!0});Object.defineProperty(b.prototype,"activeChoices",{get:function(){return this.choices.filter(function(a){return a.active})},enumerable:!1,configurable:!0});Object.defineProperty(b.prototype,"searchableChoices",{get:function(){return this.choices.filter(function(a){return!a.disabled&&!a.placeholder})},enumerable:!1,configurable:!0});
Object.defineProperty(b.prototype,"groups",{get:function(){return this.state.groups},enumerable:!1,configurable:!0});Object.defineProperty(b.prototype,"activeGroups",{get:function(){var a=this;return this.state.groups.filter(function(c){c=c.active&&!c.disabled;var d=a.state.choices.some(function(e){return e.active&&!e.disabled});return c&&d},[])},enumerable:!1,configurable:!0});b.prototype.inTxn=function(){return 0<this._txn};b.prototype.getChoiceById=function(a){return this.activeChoices.find(function(c){return c.id===
a})};b.prototype.getGroupById=function(a){return this.groups.find(function(c){return c.id===a})};return b}();const Ma=1/0,da=Object.prototype.hasOwnProperty;class Na{constructor(b){this._keys=[];this._keyMap={};let a=0;b.forEach(c=>{c=ca(c);this._keys.push(c);this._keyMap[c.id]=c;a+=c.weight});this._keys.forEach(c=>{c.weight/=a})}get(b){return this._keyMap[b]}keys(){return this._keys}toJSON(){return JSON.stringify(this._keys)}}var q=M(M(M(M({},{isCaseSensitive:!1,includeScore:!1,keys:[],shouldSort:!0,
sortFn:(b,a)=>b.score===a.score?b.idx<a.idx?-1:1:b.score<a.score?-1:1}),{includeMatches:!1,findAllMatches:!1,minMatchCharLength:1}),{location:0,threshold:.6,distance:100}),{useExtendedSearch:!1,getFn:function(b,a){let c=[],d=!1;const e=(f,g,h)=>{if(D(f))if(g[h]){if(f=f[g[h]],D(f))if(h===g.length-1&&(G(f)||"number"===typeof f||!0===f||!1===f||"object"===typeof f&&null!==f&&"[object Boolean]"==ba(f)))g=c.push,null==f?f="":"string"!=typeof f&&(h=f+"",f="0"==h&&1/f==-Ma?"-0":h),g.call(c,f);else if(F(f)){d=
!0;for(let k=0,l=f.length;k<l;k+=1)e(f[k],g,h+1)}else g.length&&e(f,g,h+1)}else c.push(f)};e(b,G(a)?a.split("."):a,0);return d?c:c[0]},ignoreLocation:!1,ignoreFieldNorm:!1,fieldNormWeight:1});const ta=/[^ ]+/g;class W{constructor({getFn:b=q.getFn,fieldNormWeight:a=q.fieldNormWeight}={}){this.norm=sa(a,3);this.getFn=b;this.isCreated=!1;this.setIndexRecords()}setSources(b=[]){this.docs=b}setIndexRecords(b=[]){this.records=b}setKeys(b=[]){this.keys=b;this._keysMap={};b.forEach((a,c)=>{this._keysMap[a.id]=
c})}create(){!this.isCreated&&this.docs.length&&(this.isCreated=!0,G(this.docs[0])?this.docs.forEach((b,a)=>{this._addString(b,a)}):this.docs.forEach((b,a)=>{this._addObject(b,a)}),this.norm.clear())}add(b){const a=this.size();G(b)?this._addString(b,a):this._addObject(b,a)}removeAt(b){this.records.splice(b,1);for(let a=b,c=this.size();a<c;a+=1)--this.records[a].i}getValueForItemAtKeyId(b,a){return b[this._keysMap[a]]}size(){return this.records.length}_addString(b,a){D(b)&&b.trim().length&&(b={v:b,
i:a,n:this.norm.get(b)},this.records.push(b))}_addObject(b,a){let c={i:a,$:{}};this.keys.forEach((d,e)=>{var f=d.getFn?d.getFn(b):this.getFn(b,d.path);if(D(f))if(F(f)){d=[];const g=[{nestedArrIndex:-1,value:f}];for(;g.length;){const {nestedArrIndex:h,value:k}=g.pop();D(k)&&(G(k)&&k.trim().length?(f={v:k,i:h,n:this.norm.get(k)},d.push(f)):F(k)&&k.forEach((l,p)=>{g.push({nestedArrIndex:p,value:l})}))}c.$[e]=d}else G(f)&&f.trim().length&&(d={v:f,n:this.norm.get(f)},c.$[e]=d)});this.records.push(c)}toJSON(){return{keys:this.keys,
records:this.records}}}class wa{constructor(b,{location:a=q.location,threshold:c=q.threshold,distance:d=q.distance,includeMatches:e=q.includeMatches,findAllMatches:f=q.findAllMatches,minMatchCharLength:g=q.minMatchCharLength,isCaseSensitive:h=q.isCaseSensitive,ignoreLocation:k=q.ignoreLocation}={}){this.options={location:a,threshold:c,distance:d,includeMatches:e,findAllMatches:f,minMatchCharLength:g,isCaseSensitive:h,ignoreLocation:k};this.pattern=h?b:b.toLowerCase();this.chunks=[];if(this.pattern.length)if(b=
(l,p)=>{var u=this.chunks,x=u.push;let w={};for(let y=0,v=l.length;y<v;y+=1){const r=l.charAt(y);w[r]=(w[r]||0)|1<<v-y-1}x.call(u,{pattern:l,alphabet:w,startIndex:p})},a=this.pattern.length,32<a){c=0;d=a%32;for(e=a-d;c<e;)b(this.pattern.substr(c,32),c),c+=32;d&&(a-=32,b(this.pattern.substr(a),a))}else b(this.pattern,0)}searchIn(b){const {isCaseSensitive:a,includeMatches:c}=this.options;a||(b=b.toLowerCase());if(this.pattern===b){var d={isMatch:!0,score:0};c&&(d.indices=[[0,b.length-1]]);return d}const {location:e,
distance:f,threshold:g,findAllMatches:h,minMatchCharLength:k,ignoreLocation:l}=this.options;let p=[],u=0,x=!1;this.chunks.forEach(({pattern:w,alphabet:y,startIndex:v})=>{const {isMatch:r,score:n,indices:C}=va(b,w,y,{location:e+v,distance:f,threshold:g,findAllMatches:h,minMatchCharLength:k,includeMatches:c,ignoreLocation:l});r&&(x=!0);u+=n;r&&C&&(p=[...p,...C])});d={isMatch:x,score:x?u/this.chunks.length:1};x&&c&&(d.indices=p);return d}}const ha=[],Oa=b=>!F(b)&&"object"===typeof b&&!(b.$and||b.$or),
qa=b=>({$and:Object.keys(b).map(a=>({[a]:b[a]}))});class N{constructor(b,a={},c){this.options=M(M({},q),a);if(this.options.useExtendedSearch)throw Error("Extended search is not available");this._keyStore=new Na(this.options.keys);this.setCollection(b,c)}setCollection(b,a){this._docs=b;if(a&&!(a instanceof W))throw Error("Incorrect 'index' type");this._myIndex=a||ea(this.options.keys,this._docs,{getFn:this.options.getFn,fieldNormWeight:this.options.fieldNormWeight})}add(b){D(b)&&(this._docs.push(b),
this._myIndex.add(b))}remove(b=()=>!1){const a=[];for(let c=0,d=this._docs.length;c<d;c+=1){const e=this._docs[c];b(e,c)&&(this.removeAt(c),--c,--d,a.push(e))}return a}removeAt(b){this._docs.splice(b,1);this._myIndex.removeAt(b)}getIndex(){return this._myIndex}search(b,{limit:a=-1}={}){const {includeMatches:c,includeScore:d,shouldSort:e,sortFn:f,ignoreFieldNorm:g}=this.options;b=G(b)?G(this._docs[0])?this._searchStringList(b):this._searchObjectList(b):this._searchLogical(b);xa(b,{ignoreFieldNorm:g});
e&&b.sort(f);"number"===typeof a&&-1<a&&(b=b.slice(0,a));return Aa(b,this._docs,{includeMatches:c,includeScore:d})}_searchStringList(b){const a=X(b,this.options);({records:b}=this._myIndex);const c=[];b.forEach(({v:d,i:e,n:f})=>{if(D(d)){var {isMatch:g,score:h,indices:k}=a.searchIn(d);g&&c.push({item:d,idx:e,matches:[{score:h,value:d,norm:f,indices:k}]})}});return c}_searchLogical(b){throw Error("Logical search is not available");}_searchObjectList(b){const a=X(b,this.options),{keys:c,records:d}=
this._myIndex,e=[];d.forEach(({$:f,i:g})=>{if(D(f)){var h=[];c.forEach((k,l)=>{h.push(...this._findMatches({key:k,value:f[l],searcher:a}))});h.length&&e.push({idx:g,item:f,matches:h})}});return e}_findMatches({key:b,value:a,searcher:c}){if(!D(a))return[];let d=[];if(F(a))a.forEach(({v:e,i:f,n:g})=>{if(D(e)){var {isMatch:h,score:k,indices:l}=c.searchIn(e);h&&d.push({score:k,key:b,value:e,idx:f,norm:g,indices:l})}});else{const {v:e,n:f}=a,{isMatch:g,score:h,indices:k}=c.searchIn(e);g&&d.push({score:h,
key:b,value:e,norm:f,indices:k})}return d}}N.version="7.0.0";N.createIndex=ea;N.parseIndex=function(b,{getFn:a=q.getFn,fieldNormWeight:c=q.fieldNormWeight}={}){const {keys:d,records:e}=b;b=new W({getFn:a,fieldNormWeight:c});b.setKeys(d);b.setIndexRecords(e);return b};N.config=q;N.parseQuery=function(b,a,{auto:c=!0}={}){const d=e=>{var f=Object.keys(e),g=!!e.$path;if(!g&&1<f.length&&!e.$and&&!e.$or)return d(qa(e));if(Oa(e)){f=g?e.$path:f[0];g=g?e.$val:e[f];if(!G(g))throw Error(`Invalid value for key ${f}`);
f={keyId:V(f),pattern:g};c&&(f.searcher=X(g,a));return f}let h={children:[],operator:f[0]};f.forEach(k=>{k=e[k];F(k)&&k.forEach(l=>{h.children.push(d(l))})});return h};b.$and||b.$or||(b=qa(b));return d(b)};var Pa=function(){function b(a){this._haystack=[];this._fuseOptions=B(B({},a.fuseOptions),{keys:E([],a.searchFields,!0),includeMatches:!0})}b.prototype.index=function(a){this._haystack=a;this._fuse&&this._fuse.setCollection(a)};b.prototype.reset=function(){this._haystack=[];this._fuse=void 0};b.prototype.isEmptyIndex=
function(){return!this._haystack.length};b.prototype.search=function(a){this._fuse||(this._fuse=new N(this._haystack,this._fuseOptions));return this._fuse.search(a).map(function(c,d){return{item:c.item,score:c.score||0,rank:d+1}})};return b}(),Y=function(b,a,c){b=b.dataset;var d=a.customProperties,e=a.labelClass;a=a.labelDescription;e&&(b.labelClass=m(e).join(" "));a&&(b.labelDescription=a);if(c&&d)if("string"===typeof d)b.customProperties=d;else{if(c="object"===typeof d){a:{for(f in d)if(Object.prototype.hasOwnProperty.call(d,
f)){var f=!1;break a}f=!0}c=!f}c&&(b.customProperties=JSON.stringify(d))}},ra=function(b,a,c){(b=(b=a&&b.querySelector("label[for='".concat(a,"']")))&&b.innerText)&&c.setAttribute("aria-label",b)},Qa={containerOuter:function(b,a,c,d,e,f,g){b=b.classNames.containerOuter;var h=document.createElement("div");h.className=m(b).join(" ");h.dataset.type=f;a&&(h.dir=a);d&&(h.tabIndex=0);c&&(h.setAttribute("role",e?"combobox":"listbox"),e?h.setAttribute("aria-autocomplete","list"):g||ra(this._docRoot,this.passedElement.element.id,
h),h.setAttribute("aria-haspopup","true"),h.setAttribute("aria-expanded","false"));g&&h.setAttribute("aria-labelledby",g);return h},containerInner:function(b){b=b.classNames.containerInner;var a=document.createElement("div");a.className=m(b).join(" ");return a},itemList:function(b,a){var c=b.searchEnabled,d=b.classNames;b=d.list;var e=d.listSingle;d=d.listItems;var f=document.createElement("div");f.className="".concat(m(b).join(" ")," ").concat(a?m(e).join(" "):m(d).join(" "));this._isSelectElement&&
c&&f.setAttribute("role","listbox");return f},placeholder:function(b,a){var c=b.allowHTML;b=b.classNames.placeholder;var d=document.createElement("div");d.className=m(b).join(" ");d.innerHTML=H(c,a);return d},item:function(b,a,c){var d,e,f,g=b.allowHTML,h=b.removeItemButtonAlignLeft,k=b.removeItemIconText,l=b.removeItemLabelText;b=b.classNames;var p=b.item,u=b.button,x=b.highlightedState,w=b.itemSelectable,y=b.placeholder,v=a.labelClass,r=a.label,n=a.disabled,C=a.value,A=K(C);b=document.createElement("div");
b.className=m(p).join(" ");v?(p=document.createElement("span"),p.innerHTML=H(g,r),p.className=m(v).join(" "),b.appendChild(p)):b.innerHTML=H(g,r);g=b.dataset;g.item="";g.id=a.id;g.value=A;Y(b,a,!0);(n||this.containerOuter.isDisabled)&&b.setAttribute("aria-disabled","true");this._isSelectElement&&(b.setAttribute("aria-selected","true"),b.setAttribute("role","option"));a.placeholder&&((d=b.classList).add.apply(d,m(y)),g.placeholder="");(e=b.classList).add.apply(e,a.highlighted?m(x):m(w));c&&(n&&(f=
b.classList).remove.apply(f,m(w)),g.deletable="",a=document.createElement("button"),a.type="button",a.className=m(u).join(" "),k=O(k,C),a.innerHTML=H(!0,k),(l=O(l,C))&&a.setAttribute("aria-label",l),a.dataset.button="",h?b.insertAdjacentElement("afterbegin",a):b.appendChild(a));return b},choiceList:function(b,a){b=b.classNames.list;var c=document.createElement("div");c.className=m(b).join(" ");a||c.setAttribute("aria-multiselectable","true");c.setAttribute("role","listbox");return c},choiceGroup:function(b,
a){var c=b.allowHTML,d=b.classNames,e=d.group;b=d.groupHeading;var f=d.itemDisabled,g=a.id;d=a.label;var h=a.disabled,k=K(d);a=document.createElement("div");a.className="".concat(m(e).join(" ")," ").concat(h?m(f).join(" "):"");a.setAttribute("role","group");e=a.dataset;e.group="";e.id=g;e.value=k;h&&a.setAttribute("aria-disabled","true");e=document.createElement("div");e.className=m(b).join(" ");e.innerHTML=H(c,d);a.appendChild(e);return a},choice:function(b,a,c){var d,e,f,g,h,k=b.allowHTML,l=b.classNames,
p=l.item,u=l.itemChoice;b=l.itemSelectable;var x=l.selectedState,w=l.itemDisabled,y=l.description,v=l.placeholder,r=a.elementId;l=a.groupId;var n=a.label,C=a.labelClass,A=a.labelDescription,z=K(a.value),t=document.createElement("div");t.id=r;t.className="".concat(m(p).join(" ")," ").concat(m(u).join(" "));p=t;C?(u=document.createElement("span"),u.innerHTML=H(k,n),u.className=m(C).join(" "),p=u,t.appendChild(u)):t.innerHTML=H(k,n);A&&(r="".concat(r,"-description"),p.setAttribute("aria-describedby",
r),n=document.createElement("span"),n.innerHTML=H(k,A),n.id=r,(d=n.classList).add.apply(d,m(y)),t.appendChild(n));a.selected&&(e=t.classList).add.apply(e,m(x));a.placeholder&&(f=t.classList).add.apply(f,m(v));d=t.dataset;e=l&&0<l;t.setAttribute("role",e?"treeitem":"option");e&&(d.groupId="".concat(l));d.choice="";d.id=a.id;d.value=z;d.selectText=c;Y(t,a,!1);a.disabled?((g=t.classList).add.apply(g,m(w)),d.choiceDisabled="",t.setAttribute("aria-disabled","true")):((h=t.classList).add.apply(h,m(b)),
d.choiceSelectable="");return t},input:function(b,a){var c=b.classNames,d=c.input;c=c.inputCloned;b=b.labelId;var e=document.createElement("input");e.type="search";e.className="".concat(m(d).join(" ")," ").concat(m(c).join(" "));e.autocomplete="off";e.autocapitalize="off";e.spellcheck=!1;e.setAttribute("role","textbox");e.setAttribute("aria-autocomplete","list");a?e.setAttribute("aria-label",a):b||ra(this._docRoot,this.passedElement.element.id,e);return e},dropdown:function(b){var a,c,d=b.classNames;
...
document.createElement("div");b.innerHTML=H(!0,a);b.className=e.join(" ");"add-choice"===c&&(a=b.dataset,a.choiceSelectable="",a.choice="");return b},option:function(b){var a=K(b.label);a=new Option(a,b.value,!1,b.selected);Y(a,b,!0);a.disabled=b.disabled;b.selected&&a.setAttribute("selected","");return a}},Ra="-ms-scroll-limit"in document.documentElement.style&&"-ms-ime-align"in document.documentElement.style,Sa={},Z=function(b){if(b)return(b=b.dataset.id)?parseInt(b,10):void 0};return function(){function b(a,
c){void 0===a&&(a="[data-choice]");void 0===c&&(c={});var d=this;this.initialisedOK=void 0;this._hasNonChoicePlaceholder=!1;this._lastAddedGroupId=this._lastAddedChoiceId=0;var e=b.defaults;this.config=B(B(B({},e.allOptions),e.options),c);Ba.forEach(function(k){d.config[k]=B(B(B({},e.allOptions[k]),e.options[k]),c[k])});var f=this.config;f.silent||this._validateConfig();var g=f.shadowRoot||document.documentElement;this._docRoot=g;g="string"===typeof a?g.querySelector(a):a;if(!g||"object"!==typeof g||
...
"select-multiple"===this._elementType;this._isSelectElement=this._isSelectOneElement||this._isSelectMultipleElement;this._canAddUserChoices=this._isTextElement&&f.addItems||this._isSelectElement&&f.addChoices;["auto","always"].includes("".concat(f.renderSelectedChoices))||(f.renderSelectedChoices="auto");f.closeDropdownOnSelect="auto"===f.closeDropdownOnSelect?this._isTextElement||this._isSelectOneElement||f.singleModeForMultiSelect:P(f.closeDropdownOnSelect);f.placeholder&&(f.placeholderValue?this._hasNonChoicePlaceholder=
!0:g.dataset.placeholder&&(this._hasNonChoicePlaceholder=!0,f.placeholderValue=g.dataset.placeholder));if(c.addItemFilter&&"function"!==typeof c.addItemFilter){var h=c.addItemFilter instanceof RegExp?c.addItemFilter:new RegExp(c.addItemFilter);f.addItemFilter=h.test.bind(h)}this.passedElement=this._isTextElement?new Ja({element:g,classNames:f.classNames}):new Ka({element:g,classNames:f.classNames,template:function(k){return d._templates.option(k)},extractPlaceholder:f.placeholder&&!this._hasNonChoicePlaceholder});
this.initialised=!1;this._store=new La;this._currentValue="";f.searchEnabled=!this._isTextElement&&f.searchEnabled||"select-multiple"===this._elementType;this._canSearch=f.searchEnabled;this._isScrollingOnIe=!1;this._highlightPosition=0;this._wasTap=!0;this._placeholderValue=this._generatePlaceholderValue();this._baseId=Ca(g,"choices-");this._direction=this.passedElement.dir;this._direction||(g=window.getComputedStyle(this.passedElement.element).direction,h=window.getComputedStyle(document.documentElement).direction,
...
(this.init(),this._initialItems=this._store.items.map(function(k){return k.value}))}Object.defineProperty(b,"defaults",{get:function(){return Object.preventExtensions({get options(){return Sa},get allOptions(){return oa},get templates(){return Qa}})},enumerable:!1,configurable:!0});b.prototype.init=function(){if(!this.initialised&&void 0===this.initialisedOK){var a=new Pa(this.config);this._searcher=a;this._loadChoices();this._createTemplates();this._createElements();this._createStructure();this._isTextElement&&
...
h.length&&this._createChoicesFragment(h,d,!1);a.forEach(function(k){var l=g(k);l.length&&(k=e._templates.choiceGroup(e.config,k),d.appendChild(k),e._createChoicesFragment(l,d,!0))});return d};b.prototype._createChoicesFragment=function(a,c,d){var e=this;void 0===c&&(c=document.createDocumentFragment());void 0===d&&(d=!1);var f=this.config,g=this._isSearching,h=this._isSelectOneElement,k=f.searchResultLimit,l=f.renderChoiceLimit,p=[],u=f.appendGroupInSearch&&g;u&&this._store.groups.forEach(function(n){p[n.id]=
n.label});if(this._isSelectElement){var x=a.filter(function(n){return!n.element});x.length&&this.passedElement.addOptions(x)}var w="auto"===f.renderSelectedChoices&&!h,y=[],v=[];a.forEach(function(n){g&&!n.rank||w&&n.selected||(e._hasNonChoicePlaceholder||!n.placeholder?v.push(n):y.push(n))});g?v.sort(Fa):f.shouldSort&&v.sort(f.sorter);a=h&&y.length?E(E([],y,!0),v,!0):v;var r=a.length;h=r;g&&0<k?h=k:0<l&&!d&&(h=l);h<r&&(r=h);r--;a.every(function(n,C){var A=e._templates.choice(f,n,f.itemSelectText);
u&&0<n.groupId&&(n=p[n.groupId])&&(A.innerHTML+=" (".concat(n,")"));c.appendChild(A);return C<r});return c};b.prototype._createItemsFragment=function(a,c){var d=this;void 0===c&&(c=document.createDocumentFragment());var e=this.config,f=e.sorter,g=e.removeItemButton,h=e.delimiter;e.shouldSortItems&&!this._isSelectOneElement&&a.sort(f);this._isTextElement&&(this.passedElement.value=a.map(function(k){return k.value}).join(h));f=function(k){k=d._templates.item(e,k,g);c.appendChild(k)};a.forEach(f);this._isSelectOneElement&&
...
b.prototype._canAddItems=function(){var a=this.config,c=a.maxItemCount,d=a.maxItemText;return!a.singleModeForMultiSelect&&0<c&&c<=this._store.items.length?(this._displayNotice("function"===typeof d?d(c):d,"add-choice"),!1):!0};b.prototype._canCreateItem=function(a){var c=this.config,d=!0,e="";d&&"function"===typeof c.addItemFilter&&!c.addItemFilter(a)&&(d=!1,e=O(c.customAddItemText,a));if(d){var f=this._store.choices.find(function(g){return c.valueComparer(g.value,a)});if(this._isSelectElement){if(f)return this._displayNotice("",
"add-choice"),!1}else this._isTextElement&&!c.duplicateItemsAllowed&&f&&(d=!1,e=O(c.uniqueItemText,a))}d&&(e=O(c.addItemText,a));e&&this._displayNotice(e,"add-choice");return d};b.prototype._searchChoices=function(a){var c=a.trim().replace(/\s{2,}/," ");if(!c.length||c===this._currentValue)return null;a=this._searcher;a.isEmptyIndex()&&a.index(this._store.searchableChoices);a=a.search(c);this._currentValue=c;this._highlightPosition=0;this._isSearching=!0;c=(c=this._notice)&&c.type;"add-choice"!==
c&&(a.length?"no-results"===c&&this._clearNotice():this._displayNotice(ja(this.config.noResultsText),"no-results"));this._store.dispatch({type:"FILTER_CHOICES",results:a});return a.length};b.prototype._stopSearch=function(){var a=this._isSearching;this._currentValue="";this._isSearching=!1;a&&(this._store.dispatch({type:"ACTIVATE_CHOICES",active:!0}),this.passedElement.triggerEvent("search",{value:"",resultCount:0}))};b.prototype._addEventListeners=function(){var a=this._docRoot,c=this.containerOuter.element,
...
function(a){var c=a.target;if(c instanceof HTMLElement){if(Ra&&this.choiceList.element.contains(c)){var d=this.choiceList.element.firstElementChild;this._isScrollingOnIe="ltr"===this._direction?a.offsetX>=d.offsetWidth:a.offsetX<d.offsetLeft}if(c!==this.input.element){c=c.closest("[data-button],[data-item],[data-choice]");if(c instanceof HTMLElement){d=a.shiftKey;var e=c.dataset;"button"in e?this._handleButtonAction(c):"item"in e?this._handleItemAction(c,d):"choice"in e&&this._handleChoiceAction(c)}a.preventDefault()}}};
...
b.prototype._onFormReset=function(){var a=this;this._store.withTxn(function(){a.clearInput();a.hideDropdown();a.refresh(!1,!1,!0);a._initialItems.length&&a.setChoiceByValue(a._initialItems)})};b.prototype._highlightChoice=function(a){var c;void 0===a&&(a=null);var d=this.config.classNames.highlightedState,e=Array.from(this.dropdown.element.querySelectorAll("[data-choice-selectable]"));e.length&&(Array.from(this.dropdown.element.querySelectorAll(T(d))).forEach(function(f){var g;(g=f.classList).remove.apply(g,
...
d={};c&&"function"===typeof c&&(d=c.call(this,Da,H));var e={};Object.keys(this._templates).forEach(function(f){e[f]=f in d?d[f].bind(a):a._templates[f].bind(a)});this._templates=e};b.prototype._createElements=function(){var a=this._templates,c=this.config,d=c.position,e=c.classNames,f=this._elementType;this.containerOuter=new ka({element:a.containerOuter(c,this._direction,this._isSelectElement,this._isSelectOneElement,c.searchEnabled,f,c.labelId),classNames:e,type:f,position:d});this.containerInner=
new ka({element:a.containerInner(c),classNames:e,type:f,position:d});this.input=new Ia({element:a.input(c,this._placeholderValue),classNames:e,type:f,preventPaste:!c.paste});this.choiceList=new la({element:a.choiceList(c,this._isSelectOneElement)});this.itemList=new la({element:a.itemList(c,this._isSelectOneElement)});this.dropdown=new Ha({element:a.dropdown(c),classNames:e,type:f})};b.prototype._createStructure=function(){var a=this.containerInner,c=this.containerOuter,d=this.passedElement,e=this.dropdown,
