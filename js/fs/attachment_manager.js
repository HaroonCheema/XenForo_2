!(function ($, window, document, _undefined) {
  ...
  XF.AttachmentManager = XF.Element.newHandler({
    ...
    selectActionClick: function (e) {
      ...
      this.$container
        .find(this.options.insertMultiRow)
    ...
    //   if ($rows.length > 1) {
        ...
        $(".js-attachmentUploads")
          .find(".progress-bar .progress-bar-fill")
          .text(done + "/" + totalf);
        $(".js-attachmentUploads")
          .find(".progress-bar .progress-bar-fill")
          .css("width", percentagedone + "%");
...
!(function (window, document, _undefined) {
  ...
  XF.AttachmentManagerWithChunkedUploads = XF.extend(XF.AttachmentManager, {
    ...
    //   flowOptions.simultaneousUploads =
    //     XF.config.chunkedUploadsSimultaneousUploads;
  ...
  XF.Element.register(
    "attachment-manager",
    "XF.AttachmentManagerWithChunkedUploads"
  );
})(window, document);
